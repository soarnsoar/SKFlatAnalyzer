...
SKFlat.py -a ForLepJetChargeReliabilityCoeff -l inputlist.txt -n 1 -e 2017 --no_exec --reduction 1000
#SKFlat.py -a ForLepJetChargeReliability -i DYJets -n 300 -e 2017
