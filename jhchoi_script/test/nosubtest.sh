...
#SKFlat.py -a BBbarRecoTMVA -i TTLJ_powheg -n 1 --reduction 1000 -e 2017 --no_exec &> test_DY_TTLJ.log&
#(SKFlat.py -a BBbarRecoTMVA -i TTLJ_powheg -n 1 --reduction 1000 -e 2017 --no_exec &> test_DY_TTLL.log;cat test_DY_TTLL.log)&
SKFlat.py -a BasicTest -i DYJets -n 1 --reduction 1000 -e 2017 --no_exec
