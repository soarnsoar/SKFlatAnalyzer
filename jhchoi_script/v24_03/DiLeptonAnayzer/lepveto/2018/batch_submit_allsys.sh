...
YEAR=2018
SKFlat.py -a DiLeptonAnalyzer  ${SKIM} -i DYJetsToMuMu_MiNNLO -n 65 -e ${YEAR} $FLAG &> syslogs/DYJetsToMuMu_MiNNLO.log&
SKFlat.py -a DiLeptonAnalyzer  ${SKIM} -i DYJetsToEE_MiNNLO -n 58 -e ${YEAR} $FLAG &> syslogs/DYJetsToEE_MiNNLO.log&
sleep 120
...
sleep 5
SKFlat.py -a DiLeptonAnalyzer  ${SKIM} -i EGamma -n 50 -e ${YEAR} $FLAG &> syslogs/EGamma.log&
sleep 5
