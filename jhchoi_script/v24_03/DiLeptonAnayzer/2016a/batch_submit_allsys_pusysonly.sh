...
#FLAG=""
YEAR=2016a
SKFlat.py -a DiLeptonAnalyzer  ${SKIM} -i  DYJetsToMuMu_MiNNLO -n 31 -e ${YEAR} $FLAG &> psyslogs/DYJetsToMuMu_MiNNLO.log&
SKFlat.py -a DiLeptonAnalyzer  ${SKIM} -i  DYJetsToEE_MiNNLO -n 18 -e ${YEAR} $FLAG &> psyslogs/DYJetsToEE_MiNNLO.log&
sleep 120
