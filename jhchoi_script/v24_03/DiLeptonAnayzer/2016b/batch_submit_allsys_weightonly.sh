...
#FLAG=""
YEAR=2016b
SKFlat.py -a DiLeptonAnalyzer  ${SKIM} -i DYJetsToMuMu_MiNNLO -n 26 -e ${YEAR} $FLAG &> wsyslogs/DYJetsToMuMu_MiNNLO.log&
SKFlat.py -a DiLeptonAnalyzer  ${SKIM} -i DYJetsToEE_MiNNLO -n 12 -e ${YEAR} $FLAG &> wsyslogs/DYJetsToEE_MiNNLO.log&
sleep 120
