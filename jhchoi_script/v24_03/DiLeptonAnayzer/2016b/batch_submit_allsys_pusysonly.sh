...
#FLAG=""
YEAR=2016b
SKFlat.py -a DiLeptonAnalyzer  ${SKIM} -i DYJetsToMuMu_MiNNLO -n 26 -e ${YEAR} $FLAG &> psyslogs/DYJetsToMuMu_MiNNLO.log&
SKFlat.py -a DiLeptonAnalyzer  ${SKIM} -i DYJetsToEE_MiNNLO -n 12 -e ${YEAR} $FLAG &> psyslogs/DYJetsToEE_MiNNLO.log&
sleep 120
...
sleep 5
SKFlat.py -a DiLeptonAnalyzer  ${SKIM} -i DoubleEG -n 50 -e ${YEAR} $FLAG &> psyslogs/DoubleEG.log&
sleep 5
