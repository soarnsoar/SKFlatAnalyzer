...
YEAR=2016b
SKFlat.py -a DiLeptonAnalyzer  ${SKIM} -i DYJetsToMuMu_MiNNLO -n 26 -e ${YEAR} $FLAG ${NMAX} &> jetpuid_loose_syslogs/DYJetsToMuMu_MiNNLO.log&
SKFlat.py -a DiLeptonAnalyzer  ${SKIM} -i DYJetsToEE_MiNNLO -n 12 -e ${YEAR} $FLAG ${NMAX} &> jetpuid_loose_syslogs/DYJetsToEE_MiNNLO.log&
sleep 120
