...
#FLAG=""
YEAR=2016b
SKFlat.py -a PreselectionAnalyzer  ${SKIM} -l  inputlist_major.txt -n 30 -e ${YEAR} $FLAG &> syslogs/major.log&
sleep 120
...
sleep 5
SKFlat.py -a PreselectionAnalyzer  ${SKIM} -i DoubleEG -n 50 -e ${YEAR} $FLAG &> syslogs/DoubleEG.log&
sleep 5
