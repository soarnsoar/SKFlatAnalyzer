...
YEAR=2018
SKFlat.py -a TTsemiLepChargeScoreEfficiencyMeasurement_TightMatch  ${SKIM} -i TTLJ_powheg -n 400 -e ${YEAR} $FLAG ${MEMORYHIGH} ${NMAX} &> use_beff_dasym_ForMeasure_syslogs/TTLJ_powheg.log&
...
SKFlat.py -a TTsemiLepChargeScoreEfficiencyMeasurement_TightMatch  ${SKIM} -i EGamma -n 50 -e ${YEAR} $FLAG ${MEMORY} ${NMAX} &> use_beff_dasym_ForMeasure_syslogs/EGamma.log&
