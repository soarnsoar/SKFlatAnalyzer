...
SKFlat.py -a TTsemiLepChargeScoreEfficiencyMeasurement_TightMatch   -i SingleMuon -n 50 -e ${YEAR} $FLAG ${MEMORY} ${NMAX} &> use_beff_dasym_ForMeasure_syslogs/SingleMuon.log&
SKFlat.py -a TTsemiLepChargeScoreEfficiencyMeasurement_TightMatch   -i SingleElectron -n 50 -e ${YEAR} $FLAG ${MEMORY} ${NMAX} &> use_beff_dasym_ForMeasure_syslogs/SingleElectron.log&
