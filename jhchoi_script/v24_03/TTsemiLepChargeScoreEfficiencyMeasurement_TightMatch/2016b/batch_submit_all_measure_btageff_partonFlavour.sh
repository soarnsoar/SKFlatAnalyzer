...
#SKFlat.py -a TTsemiLepChargeScoreEfficiencyMeasurement_TightMatch   -i SingleMuon -n 50 -e ${YEAR} $FLAG &> measure_btageff_partonFlavour_logs/SingleMuon.log&
#SKFlat.py -a TTsemiLepChargeScoreEfficiencyMeasurement_TightMatch   -i SingleElectron -n 50 -e ${YEAR} $FLAG &> measure_btageff_partonFlavour_logs/SingleElectron.log&
