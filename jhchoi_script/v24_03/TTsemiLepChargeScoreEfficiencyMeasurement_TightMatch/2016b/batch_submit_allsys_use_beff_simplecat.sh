...
SKFlat.py -a TTsemiLepChargeScoreEfficiencyMeasurement_TightMatch   -i SingleMuon -n 50 -e ${YEAR} $FLAG ${MEMORY} &> use_beff_simplecat_syslogs/SingleMuon.log&
SKFlat.py -a TTsemiLepChargeScoreEfficiencyMeasurement_TightMatch   -i SingleElectron -n 50 -e ${YEAR} $FLAG ${MEMORY} &> use_beff_simplecat_syslogs/SingleElectron.log&
