...
SKIM=""
FLAG="--userflags runSys,noveto,FlavourMatchBase,HcbCR"
YEAR=2016b
...
SKFlat.py -a TTsemiLepChargeScoreEfficiencyMeasurement   -i SingleMuon -n 50 -e ${YEAR} $FLAG &> syslogs/SingleMuon.log&
SKFlat.py -a TTsemiLepChargeScoreEfficiencyMeasurement   -i SingleElectron -n 50 -e ${YEAR} $FLAG &> syslogs/SingleElectron.log&
