...
SKFlat.py -a TTsemiLepChargeScoreEfficiencyMeasurement  ${SKIM} -i TTLJ_powheg -n 250 -e ${YEAR} $FLAG ${MAXJOB} ${MEM_TTLJ} &> use_beff_dasym_JETPUID_L_chi2kincut_bdt2512.5_splitcharge_syslogs/TTLJ_powheg.log&
sleep 15
...
sleep 15
SKFlat.py -a TTsemiLepChargeScoreEfficiencyMeasurement  ${SKIM} -i EGamma -n 20 -e ${YEAR} $FLAG ${MAXJOB} ${MEM} &> use_beff_dasym_JETPUID_L_chi2kincut_bdt2512.5_splitcharge_syslogs/EGamma.log&
sleep 15
