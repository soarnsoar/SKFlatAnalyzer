...
SKFlat.py -a TTsemiLepChargeScoreEfficiencyMeasurement  ${SKIM} -i TTLJ_powheg -n 150 -e ${YEAR} $FLAG ${MAXJOB} ${MEM_TT} ${C_TT}&> use_beff_dasym_JETPUID_L_chi2kincut_bdt2512.5_splitcharge_noetabin_apply_bchargeideff_logs/TTLJ_powheg.log&
sleep 15
