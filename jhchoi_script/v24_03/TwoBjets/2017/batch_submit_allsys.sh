...
SKFlat.py -a TwoBjets  ${SKIM} -i  TTLJ_powheg -n 200 -e ${YEAR} $FLAG &> syslogs/TTLJ_powheg.log&
...
SKFlat.py -a TwoBjets  ${SKIM} -i SingleMuon -n 50 -e ${YEAR} $FLAG &> syslogs/SingleMuon.log&
SKFlat.py -a TwoBjets  ${SKIM} -i SingleElectron -n 50 -e ${YEAR} $FLAG &> syslogs/SingleElectron.log&
