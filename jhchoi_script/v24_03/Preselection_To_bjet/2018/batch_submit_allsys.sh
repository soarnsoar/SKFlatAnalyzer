...
#FLAG=""
YEAR=2018
SKFlat.py -a Preselection_To_bjet  ${SKIM} -l  inputlist_major.txt -n 50 -e ${YEAR} $FLAG &> syslogs/major.log&
sleep 120
...
sleep 5
SKFlat.py -a Preselection_To_bjet  ${SKIM} -i EGamma -n 50 -e ${YEAR} $FLAG &> syslogs/EGamma.log&
sleep 5
