...
SKFlat.py -a TTsemiLep_JES_Asym_TEST  ${SKIM} -i TTLJ_powheg -n 150 -e ${YEAR} $FLAG ${MAXJOB} ${MEM_TT} ${C_TT}&> use_beff_JETPUID_L_splitcharge_syslogs/TTLJ_powheg.log&
sleep 15
SKFlat.py -a TTsemiLep_JES_Asym_TEST  ${SKIM} -i TTLL_powheg -n 30 -e ${YEAR} $FLAG ${MAXJOB} ${MEM_TT} ${C_TT} &> use_beff_JETPUID_L_splitcharge_syslogs/TTLL_powheg.log&
sleep 15
##--DY
...
sleep 15
SKFlat.py -a TTsemiLep_JES_Asym_TEST  ${SKIM} -i SingleMuon -n 20 -e ${YEAR} $FLAG ${MAXJOB}  &> use_beff_JETPUID_L_splitcharge_syslogs/SingleMuon.log&
sleep 15
SKFlat.py -a TTsemiLep_JES_Asym_TEST  ${SKIM} -i SingleElectron -n 20 -e ${YEAR} $FLAG ${MAXJOB}  &> use_beff_JETPUID_L_splitcharge_syslogs/SingleElectron.log&
sleep 15
