...
SKFlat.py -a TTsemiLep_JES_Asym_TEST  ${SKIM} -i TTLJ_powheg -n 180 -e ${YEAR} $FLAG ${MAXJOB} ${MEM_TT} ${C_TT} &> use_beff_JETPUID_L_splitcharge_syslogs/TTLJ_powheg.log&
sleep 15
...
sleep 15
SKFlat.py -a TTsemiLep_JES_Asym_TEST  ${SKIM} -i EGamma -n 20 -e ${YEAR} $FLAG ${MAXJOB}  &> use_beff_JETPUID_L_splitcharge_syslogs/EGamma.log&
