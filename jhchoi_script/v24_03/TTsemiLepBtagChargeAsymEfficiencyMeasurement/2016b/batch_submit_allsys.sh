...
sleep 15
SKFlat.py -a TTsemiLepBtagChargeAsymEfficiencyMeasurement   -i SingleMuon -n 20 -e ${YEAR} $FLAG $MAXJOB &> syslogs/SingleMuon.log&
sleep 15
SKFlat.py -a TTsemiLepBtagChargeAsymEfficiencyMeasurement   -i SingleElectron -n 20 -e ${YEAR} $FLAG $MAXJOB &> syslogs/SingleElectron.log&
sleep 15
