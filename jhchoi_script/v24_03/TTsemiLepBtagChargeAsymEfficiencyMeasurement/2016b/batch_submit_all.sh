...
sleep 15
SKFlat.py -a TTsemiLepBtagChargeAsymEfficiencyMeasurement   -i SingleMuon -n 20 -e ${YEAR} $FLAG $MAXJOB &> logs/SingleMuon.log&
sleep 15
SKFlat.py -a TTsemiLepBtagChargeAsymEfficiencyMeasurement   -i SingleElectron -n 20 -e ${YEAR} $FLAG $MAXJOB &> logs/SingleElectron.log&
sleep 15
