...
MAXJOB=" --nmax 300 "
YEAR=2016b
SKFlat.py -a TTsemiLepBtagChargeAsymEfficiencyMeasurement  ${SKIM} -i TTLJ_powheg -n 150 -e ${YEAR} $FLAG ${MAXJOB} &> ApplyBtagSF_syslogs/TTLJ_powheg.log&
sleep 15
...
sleep 15
SKFlat.py -a TTsemiLepBtagChargeAsymEfficiencyMeasurement   -i SingleMuon -n 20 -e ${YEAR} $FLAG $MAXJOB &> ApplyBtagSF_syslogs/SingleMuon.log&
sleep 15
SKFlat.py -a TTsemiLepBtagChargeAsymEfficiencyMeasurement   -i SingleElectron -n 20 -e ${YEAR} $FLAG $MAXJOB &> ApplyBtagSF_syslogs/SingleElectron.log&
sleep 15
