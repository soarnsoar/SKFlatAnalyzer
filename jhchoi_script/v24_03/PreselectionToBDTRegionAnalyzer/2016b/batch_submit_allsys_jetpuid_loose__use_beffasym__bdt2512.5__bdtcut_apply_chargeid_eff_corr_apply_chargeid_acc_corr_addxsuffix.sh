...
MEM="--memory 9500"
YEAR=2016b
SKFlat.py -a PreselectionToBDTRegionAnalyzer  ${SKIM} -l  inputlist_major.txt -n 50  --count 3 -e ${YEAR} $FLAG ${NMAX} ${MEM} &> jetpuid_loose_use_beffasym_bdt2512.5_bdtcut_apply_chargeid_eff_corr_apply_chargeid_acc_corr_addxsuffix_syslogs/major.log&
MEM=""
...
SKFlat.py -a PreselectionToBDTRegionAnalyzer  ${SKIM} -i DoubleEG -n 50 -e ${YEAR} $FLAG ${NMAX} ${MEM} &> jetpuid_loose_use_beffasym_bdt2512.5_bdtcut_apply_chargeid_eff_corr_apply_chargeid_acc_corr_addxsuffix_syslogs/DoubleEG.log&
