...
NMAX="--nmax 400"
MEM="--memory 9500"
SKFlat.py -a PreselectionToBDTRegionAnalyzer  ${SKIM} -l  inputlist_major.txt -n 80 --count 3 -e ${YEAR} $FLAG ${NMAX} ${MEM} &> jetpuid_loose_lepveto_use_beffasym_bdt2512.5_bdtcut_apply_chargeid_eff_corr_syslogs/major.log&
MEM=""
...
SKFlat.py -a PreselectionToBDTRegionAnalyzer  ${SKIM} -i EGamma -n 50 -e ${YEAR} $FLAG ${NMAX} ${MEM} &> jetpuid_loose_lepveto_use_beffasym_bdt2512.5_bdtcut_apply_chargeid_eff_corr_syslogs/EGamma.log&
