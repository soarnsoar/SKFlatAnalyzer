...
SKFlat.py -a SingleLeptonAnalyzer   -i SingleMuon -n 50 -e ${YEAR} $FLAG &> syslogs/SingleMuon.log&
SKFlat.py -a SingleLeptonAnalyzer   -i SingleElectron -n 50 -e ${YEAR} $FLAG &> syslogs/SingleElectron.log&
