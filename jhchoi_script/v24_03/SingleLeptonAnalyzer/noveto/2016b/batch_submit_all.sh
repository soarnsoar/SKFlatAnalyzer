...
SKFlat.py -a SingleLeptonAnalyzer   -i SingleMuon -n 50 -e ${YEAR} $FLAG &> logs/SingleMuon.log&
SKFlat.py -a SingleLeptonAnalyzer   -i SingleElectron -n 50 -e ${YEAR} $FLAG &> logs/SingleElectron.log&
