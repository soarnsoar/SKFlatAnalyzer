...
#sleep 15
#SKFlat.py -a TTsemiLepBtagChargeAsymEfficiencyMeasurement_BINNING  ${SKIM} -i EGamma -n 20 -e ${YEAR} $FLAG $MAXJOB &> measure_btageff_partonFlavour_bonly_logs/EGamma.log&
#sleep 15
