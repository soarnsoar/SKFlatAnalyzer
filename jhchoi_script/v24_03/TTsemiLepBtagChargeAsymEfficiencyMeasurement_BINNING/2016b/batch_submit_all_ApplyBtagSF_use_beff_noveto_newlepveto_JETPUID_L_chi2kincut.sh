...
YEAR=2016b
MEM2="--memory 3199"
SKFlat.py -a TTsemiLepBtagChargeAsymEfficiencyMeasurement_BINNING  ${SKIM} -i TTLJ_powheg -n 150 -e ${YEAR} $FLAG ${MAXJOB}  ${MEM} ${C}&> ApplyBtagSF_use_beff_noveto_newlepveto_JETPUID_L_chi2kincut_logs/TTLJ_powheg.log&
sleep 15
...
sleep 15
SKFlat.py -a TTsemiLepBtagChargeAsymEfficiencyMeasurement_BINNING   -i SingleMuon -n 20 -e ${YEAR} $FLAG $MAXJOB ${MEM2} &> ApplyBtagSF_use_beff_noveto_newlepveto_JETPUID_L_chi2kincut_logs/SingleMuon.log&
sleep 15
SKFlat.py -a TTsemiLepBtagChargeAsymEfficiencyMeasurement_BINNING   -i SingleElectron -n 20 -e ${YEAR} $FLAG $MAXJOB ${MEM2} &> ApplyBtagSF_use_beff_noveto_newlepveto_JETPUID_L_chi2kincut_logs/SingleElectron.log&
sleep 15
