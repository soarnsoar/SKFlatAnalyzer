...
sleep 15
#SKFlat.py -a TTsemiLepBtagChargeAsymEfficiencyMeasurement_BINNING   -i SingleMuon -n 20 -e ${YEAR} $FLAG $MAXJOB &> measure_btageff_partonFlavour_bonly_logs/SingleMuon.log&
#sleep 15
#SKFlat.py -a TTsemiLepBtagChargeAsymEfficiencyMeasurement_BINNING   -i SingleElectron -n 20 -e ${YEAR} $FLAG $MAXJOB &> measure_btageff_partonFlavour_bonly_logs/SingleElectron.log&
#sleep 15
