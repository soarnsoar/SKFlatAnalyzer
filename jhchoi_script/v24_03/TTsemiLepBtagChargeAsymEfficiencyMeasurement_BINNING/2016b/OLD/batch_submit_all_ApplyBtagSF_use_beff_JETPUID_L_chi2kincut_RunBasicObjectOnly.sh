...
sleep 15
SKFlat.py -a TTsemiLepBtagChargeAsymEfficiencyMeasurement_BINNING   -i SingleMuon -n 20 -e ${YEAR} $FLAG $MAXJOB &> ApplyBtagSF_use_beff_JETPUID_L_chi2kincut_RunBasicObjectOnly_logs/SingleMuon.log&
sleep 15
SKFlat.py -a TTsemiLepBtagChargeAsymEfficiencyMeasurement_BINNING   -i SingleElectron -n 20 -e ${YEAR} $FLAG $MAXJOB &> ApplyBtagSF_use_beff_JETPUID_L_chi2kincut_RunBasicObjectOnly_logs/SingleElectron.log&
sleep 15
...
sleep 15
SKFlat.py -a TTsemiLepBtagChargeAsymEfficiencyMeasurement_BINNING -i WJets_Sherpa -n 10 -e ${YEAR} $FLAG ${MAXJOB} &> ApplyBtagSF_use_beff_JETPUID_L_chi2kincut_RunBasicObjectOnly_logs/WJets_Sherpa.log&
sleep 15
SKFlat.py -a TTsemiLepBtagChargeAsymEfficiencyMeasurement_BINNING -l inputlist_QCD_LepEnriched.txt -n 10 -e ${YEAR} $FLAG ${MAXJOB} &> ApplyBtagSF_use_beff_JETPUID_L_chi2kincut_RunBasicObjectOnly_logs/QCD_LepEnriched.txt.log&
