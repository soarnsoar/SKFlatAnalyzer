...
MEM2="--memory 3199"
SKFlat.py -a TTsemiLepBtagChargeAsymEfficiencyMeasurement_BINNING  ${SKIM} -i TTLJ_powheg -n 200 -e ${YEAR} $FLAG $MAXJOB ${MEM} ${C} &> ApplyBtagSF_use_beff_noveto_newlepveto_JETPUID_L_chi2kincut_logs/TTLJ_powheg.log&
sleep 15
SKFlat.py -a TTsemiLepBtagChargeAsymEfficiencyMeasurement_BINNING  ${SKIM} -l  inputlist_major.txt -n 50 -e ${YEAR} $FLAG $MAXJOB ${MEM} ${C} &> ApplyBtagSF_use_beff_noveto_newlepveto_JETPUID_L_chi2kincut_logs/major.log&
sleep 15
SKFlat.py -a TTsemiLepBtagChargeAsymEfficiencyMeasurement_BINNING  ${SKIM} -l inputlist_minor.txt -n 50 -e ${YEAR} $FLAG $MAXJOB ${MEM} ${C} &> ApplyBtagSF_use_beff_noveto_newlepveto_JETPUID_L_chi2kincut_logs/minor.log&
sleep 15
