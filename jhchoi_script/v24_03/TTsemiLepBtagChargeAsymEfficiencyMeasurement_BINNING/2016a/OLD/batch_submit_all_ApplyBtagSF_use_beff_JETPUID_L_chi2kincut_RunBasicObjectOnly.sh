...
sleep 15
SKFlat.py -a TTsemiLepBtagChargeAsymEfficiencyMeasurement_BINNING  ${SKIM} -i SingleElectron -n 20 -e ${YEAR} $FLAG ${MAXJOB} &> ApplyBtagSF_use_beff_JETPUID_L_chi2kincut_RunBasicObjectOnly_logs/SingleElectron.log&
sleep 15
