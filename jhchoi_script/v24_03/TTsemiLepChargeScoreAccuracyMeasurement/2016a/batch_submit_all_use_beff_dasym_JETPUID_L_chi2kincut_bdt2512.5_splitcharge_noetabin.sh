...
sleep 15
SKFlat.py -a TTsemiLepChargeScoreAccuracyMeasurement  ${SKIM} -i TTLL_powheg -n 40 -e ${YEAR} $FLAG ${MAXJOB} &> use_beff_dasym_JETPUID_L_chi2kincut_bdt2512.5_splitcharge_noetabin_logs/TTLL_powheg.log&
sleep 15
##--DY
...
sleep 15
SKFlat.py -a TTsemiLepChargeScoreAccuracyMeasurement  ${SKIM} -i SingleMuon -n 40 -e ${YEAR} $FLAG ${MAXJOB} &> use_beff_dasym_JETPUID_L_chi2kincut_bdt2512.5_splitcharge_noetabin_logs/SingleMuon.log&
sleep 15
SKFlat.py -a TTsemiLepChargeScoreAccuracyMeasurement  ${SKIM} -i SingleElectron -n 40 -e ${YEAR} $FLAG ${MAXJOB}  &> use_beff_dasym_JETPUID_L_chi2kincut_bdt2512.5_splitcharge_noetabin_logs/SingleElectron.log&
