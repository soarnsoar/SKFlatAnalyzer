...
SKFlat.py -a TTsemiLepChargeScoreAccuracyMeasurement  ${SKIM} -i TTLJ_powheg -n 50 -e ${YEAR} $FLAG ${MAXJOB} &> use_beff_dasym_JETPUID_L_chi2kincut_bdt2512.5_splitcharge_noetabin_measure_bchargeacc_logs/TTLJ_powheg.log&
sleep 15
...
#SKFlat.py -a TTsemiLepChargeScoreAccuracyMeasurement  ${SKIM} -l inputlist_minor.txt -n 30 -e ${YEAR} $FLAG ${MAXJOB} &> use_beff_dasym_JETPUID_L_chi2kincut_bdt2512.5_splitcharge_noetabin_measure_bchargeacc_logs/minor.log&
#sleep 15
