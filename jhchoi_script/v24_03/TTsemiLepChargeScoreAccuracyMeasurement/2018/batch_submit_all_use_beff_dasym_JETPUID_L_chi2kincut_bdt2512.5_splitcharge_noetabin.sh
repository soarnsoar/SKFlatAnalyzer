...
SKFlat.py -a TTsemiLepChargeScoreAccuracyMeasurement  ${SKIM} -i TTLJ_powheg -n 120 -e ${YEAR} $FLAG ${MAXJOB} &> use_beff_dasym_JETPUID_L_chi2kincut_bdt2512.5_splitcharge_noetabin_logs/TTLJ_powheg.log&
sleep 15
SKFlat.py -a TTsemiLepChargeScoreAccuracyMeasurement  ${SKIM} -i TTLL_powheg -n 60 -e ${YEAR} $FLAG ${MAXJOB} &> use_beff_dasym_JETPUID_L_chi2kincut_bdt2512.5_splitcharge_noetabin_logs/TTLL_powheg.log&
sleep 15
##--DY
...
SKFlat.py -a TTsemiLepChargeScoreAccuracyMeasurement  ${SKIM} -l inputlist_minor.txt -n 30 -e ${YEAR} $FLAG ${MAXJOB} &> use_beff_dasym_JETPUID_L_chi2kincut_bdt2512.5_splitcharge_noetabin_logs/minor.log&
sleep 15
...
sleep 15
SKFlat.py -a TTsemiLepChargeScoreAccuracyMeasurement  ${SKIM} -i SingleMuon -n 50 -e ${YEAR} $FLAG ${MAXJOB}  &> use_beff_dasym_JETPUID_L_chi2kincut_bdt2512.5_splitcharge_noetabin_logs/SingleMuon.log&
sleep 15
SKFlat.py -a TTsemiLepChargeScoreAccuracyMeasurement  ${SKIM} -i EGamma -n 50 -e ${YEAR} $FLAG ${MAXJOB}  &> use_beff_dasym_JETPUID_L_chi2kincut_bdt2512.5_splitcharge_noetabin_logs/EGamma.log&
