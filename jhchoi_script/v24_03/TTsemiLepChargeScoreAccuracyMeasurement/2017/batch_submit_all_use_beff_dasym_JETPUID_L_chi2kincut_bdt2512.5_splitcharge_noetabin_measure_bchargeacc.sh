...
#SKFlat.py -a TTsemiLepChargeScoreAccuracyMeasurement  ${SKIM} -l inputlist_minor.txt -n 10 -e ${YEAR} $FLAG $MAXJOB &> use_beff_dasym_JETPUID_L_chi2kincut_bdt2512.5_splitcharge_noetabin_measure_bchargeacc_logs/minor.log&
#sleep 15
