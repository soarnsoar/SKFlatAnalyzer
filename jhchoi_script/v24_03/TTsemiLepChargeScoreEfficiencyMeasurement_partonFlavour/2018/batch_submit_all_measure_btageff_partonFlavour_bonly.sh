...
sleep 10
SKFlat.py -a TTsemiLepChargeScoreEfficiencyMeasurement_partonFlavour  ${SKIM} -i EGamma -n 50 -e ${YEAR} $FLAG $NMAX  &> measure_btageff_partonFlavour_bonly_logs/EGamma.log&
sleep 10
