...
SKFlat.py -a TTsemiLepChargeScoreEfficiencyMeasurement_partonFlavour   -i SingleMuon -n 50 -e ${YEAR} $FLAG &> measure_btageff_logs/SingleMuon.log&
SKFlat.py -a TTsemiLepChargeScoreEfficiencyMeasurement_partonFlavour   -i SingleElectron -n 50 -e ${YEAR} $FLAG &> measure_btageff_logs/SingleElectron.log&
