...
SKFlat.py -a TTsemiLepChargeScoreEfficiencyMeasurement_partonFlavour  ${SKIM} -i TTLJ_powheg -n 200 -e ${YEAR} $FLAG ${MEMORYHIGH} ${NMAX} &> use_beff_ForMeasure_syslogs/TTLJ_powheg.log&
...
SKFlat.py -a TTsemiLepChargeScoreEfficiencyMeasurement_partonFlavour   -i SingleMuon -n 50 -e ${YEAR} $FLAG ${MEMORY} ${NMAX} &> use_beff_ForMeasure_syslogs/SingleMuon.log&
SKFlat.py -a TTsemiLepChargeScoreEfficiencyMeasurement_partonFlavour   -i SingleElectron -n 50 -e ${YEAR} $FLAG ${MEMORY} ${NMAX} &> use_beff_ForMeasure_syslogs/SingleElectron.log&
