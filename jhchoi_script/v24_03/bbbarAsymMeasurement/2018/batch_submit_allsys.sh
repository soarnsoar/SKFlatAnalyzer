...
YEAR=2018
NMAX="--nmax 700"
SKFlat.py -a bbbarAsymMeasurement  ${SKIM} -l  inputlist_major.txt -n 50 -e ${YEAR} $FLAG ${NMAX} &> syslogs/major.log&
sleep 120
...
sleep 5
SKFlat.py -a bbbarAsymMeasurement  ${SKIM} -i EGamma -n 50 -e ${YEAR} $FLAG ${NMAX} &> syslogs/EGamma.log&
sleep 5
