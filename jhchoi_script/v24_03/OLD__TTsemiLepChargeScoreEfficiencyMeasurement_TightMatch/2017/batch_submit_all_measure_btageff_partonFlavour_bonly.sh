...
sleep 10
SKFlat.py -a TTsemiLepChargeScoreEfficiencyMeasurement_TightMatch  ${SKIM} -i SingleElectron -n 50 -e ${YEAR} $FLAG $NMAX  &> measure_btageff_partonFlavour_bonly_logs/SingleElectron.log&
sleep 10
