...
SKIM=""
FLAG="--userflags runSys,MuonChargeOnly"
YEAR=2016b
...
SKFlat.py -a TTsemiLepChargeScoreEfficiencyMeasurement_TightMatch   -i SingleMuon -n 50 -e ${YEAR} $FLAG &> syslogs/SingleMuon.log&
SKFlat.py -a TTsemiLepChargeScoreEfficiencyMeasurement_TightMatch   -i SingleElectron -n 50 -e ${YEAR} $FLAG &> syslogs/SingleElectron.log&
