...
SKFlat.py -a TTSemiLepAnalyzer   -i SingleMuon -n 50 -e ${YEAR} $FLAG &> logs/SingleMuon.log&
SKFlat.py -a TTSemiLepAnalyzer   -i SingleElectron -n 50 -e ${YEAR} $FLAG &> logs/SingleElectron.log&
