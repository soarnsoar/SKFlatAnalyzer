...
SKFlat.py -a PreselectionAnalyzer -l ${SKIM} inputlist_NoSkim.txt -n 50 -e ${YEAR} $FLAG ${NMAX} ${MEM} &> jetpuid_loose_newlepveto_check_tmva_input_1bskim_syslogs/NoSkim.log&
