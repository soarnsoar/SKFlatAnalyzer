...
SKFlat.py -a PreselectionAnalyzer  ${SKIM} -i DoubleEG -n 50 -e ${YEAR} $FLAG ${NMAX} ${MEM} &> jetpuid_loose_newlepveto_use_beffasym_bdt_v2608_2_bdtopt_bdtopt_jet_logs/DoubleEG.log&
