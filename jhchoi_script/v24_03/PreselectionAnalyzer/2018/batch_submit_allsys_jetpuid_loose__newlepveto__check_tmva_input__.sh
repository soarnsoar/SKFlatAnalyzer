...
SKFlat.py -a PreselectionAnalyzer  ${SKIM} -i EGamma -n 50 -e ${YEAR} $FLAG ${NMAX}   ${MEM} &> jetpuid_loose_newlepveto_check_tmva_input_syslogs/EGamma.log&
SKFlat.py -a PreselectionAnalyzer -l inputlist_NoSkim.txt -n 50 -e ${YEAR} $FLAG ${NMAX}   ${MEM} &> jetpuid_loose_newlepveto_check_tmva_input_syslogs/NoSkim.log&
