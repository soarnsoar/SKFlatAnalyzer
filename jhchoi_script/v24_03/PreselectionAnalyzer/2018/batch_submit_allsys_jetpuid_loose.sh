...
NMAX="--nmax 400"
MEM="--memory 9500"
SKFlat.py -a PreselectionAnalyzer  ${SKIM} -l  inputlist_major.txt -n 50 -e ${YEAR} $FLAG ${NMAX} ${MEM} &> jetpuid_loose_syslogs/major.log&
sleep 5
MEM="--memory 3200"
...
sleep 5
SKFlat.py -a PreselectionAnalyzer  ${SKIM} -i EGamma -n 50 -e ${YEAR} $FLAG ${NMAX} ${MEM} &> jetpuid_loose_syslogs/EGamma.log&
sleep 5
