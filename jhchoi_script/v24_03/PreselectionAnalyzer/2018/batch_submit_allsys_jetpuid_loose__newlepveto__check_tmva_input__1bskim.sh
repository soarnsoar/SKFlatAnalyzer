...
YEAR=2018
SKFlat.py -a PreselectionAnalyzer  ${SKIM} -l  inputlist_major.txt -n 50 -e ${YEAR} $FLAG ${NMAX}  ${MEM} &> jetpuid_loose_newlepveto_check_tmva_input_1bskim_syslogs/major.log&
...
SKFlat.py -a PreselectionAnalyzer  ${SKIM} -i EGamma -n 50 -e ${YEAR} $FLAG ${NMAX}   ${MEM} &> jetpuid_loose_newlepveto_check_tmva_input_1bskim_syslogs/EGamma.log&
