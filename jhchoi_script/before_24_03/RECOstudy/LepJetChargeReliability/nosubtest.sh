...
##test trainingmode
(SKFlat.py -a LepJetChargeReliability_RECO -i DYJetsToEE_MiNNLO -n 1 --reduction 1000 -e 2017 --no_exec --userflag TrainingMode &> test_DYJetsToEE_MiNNLO.log;cat test_DYJetsToEE_MiNNLO.log)&
