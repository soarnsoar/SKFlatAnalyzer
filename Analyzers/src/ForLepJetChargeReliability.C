#include "ForLepJetChargeReliability.h"


ForLepJetChargeReliability::ForLepJetChargeReliability(){//FYI : bottomness = -nb
  ...
  //---tree init---//
  jhchoi_newtree=new TTree("Tree_LepChargeMatch_Group1","Tree_LepChargeMatch_Group1");
  jhchoi_newtree2=new TTree("Tree_LepChargeUnmatch_Group1","Tree_LepChargeUnmatch_Group1");
  jhchoi_newtree3=new TTree("Tree_LepChargeMatch_Group2","Tree_LepChargeMatch_Group2");
  jhchoi_newtree4=new TTree("Tree_LepChargeUnmatch_Group2","Tree_LepChargeUnmatch_Group2");
  ...
  jhchoi_newtree3->Branch("bmuon_pt",&bmuon_pt);
  jhchoi_newtree3->Branch("bmuon_eta",&bmuon_eta);
  jhchoi_newtree3->Branch("bmuon_phi",&bmuon_phi);
  jhchoi_newtree3->Branch("bmuon_ptwrtbjet",&bmuon_ptwrtbjet);
  jhchoi_newtree3->Branch("bmuon_p_jetrestf",&bmuon_p_jetrestf);
  jhchoi_newtree3->Branch("bmuon_dR_l_j",&bmuon_dR_l_j);
  jhchoi_newtree3->Branch("bmuon_nsip3d",&bmuon_nsip3d);
  jhchoi_newtree3->Branch("bmuon_reltrkiso",&bmuon_reltrkiso);
  jhchoi_newtree3->Branch("bmuon_reliso",&bmuon_reliso);
  jhchoi_newtree3->Branch("bmuon_charge",&bmuon_charge);
  jhchoi_newtree3->Branch("n_bmuon",&n_bmuon);

  jhchoi_newtree3->Branch("belectron_pt",&belectron_pt);
  jhchoi_newtree3->Branch("belectron_eta",&belectron_eta);
  jhchoi_newtree3->Branch("belectron_phi",&belectron_phi);
  jhchoi_newtree3->Branch("belectron_ptwrtbjet",&belectron_ptwrtbjet);
  jhchoi_newtree3->Branch("belectron_p_jetrestf",&belectron_p_jetrestf);
  jhchoi_newtree3->Branch("belectron_dR_l_j",&belectron_dR_l_j);
  jhchoi_newtree3->Branch("belectron_nsip3d",&belectron_nsip3d);
  jhchoi_newtree3->Branch("belectron_reltrkiso",&belectron_reltrkiso);
  jhchoi_newtree3->Branch("belectron_reliso",&belectron_reliso);
  jhchoi_newtree3->Branch("belectron_charge",&belectron_charge);
  jhchoi_newtree3->Branch("belectron_elecalclusteriso",&belectron_elecalclusteriso);
  jhchoi_newtree3->Branch("belectron_IsGsfCtfScPixChargeConsistent",&belectron_IsGsfCtfScPixChargeConsistent);
  ...
  jhchoi_newtree4->Branch("bmuon_pt",&bmuon_pt);
  jhchoi_newtree4->Branch("bmuon_eta",&bmuon_eta);
  jhchoi_newtree4->Branch("bmuon_phi",&bmuon_phi);
  jhchoi_newtree4->Branch("bmuon_ptwrtbjet",&bmuon_ptwrtbjet);
  jhchoi_newtree4->Branch("bmuon_p_jetrestf",&bmuon_p_jetrestf);
  jhchoi_newtree4->Branch("bmuon_dR_l_j",&bmuon_dR_l_j);
  jhchoi_newtree4->Branch("bmuon_nsip3d",&bmuon_nsip3d);
  jhchoi_newtree4->Branch("bmuon_reltrkiso",&bmuon_reltrkiso);
  jhchoi_newtree4->Branch("bmuon_reliso",&bmuon_reliso);
  jhchoi_newtree4->Branch("bmuon_charge",&bmuon_charge);
  jhchoi_newtree4->Branch("n_bmuon",&n_bmuon);

  jhchoi_newtree4->Branch("belectron_pt",&belectron_pt);
  jhchoi_newtree4->Branch("belectron_eta",&belectron_eta);
  jhchoi_newtree4->Branch("belectron_phi",&belectron_phi);
  jhchoi_newtree4->Branch("belectron_ptwrtbjet",&belectron_ptwrtbjet);
  jhchoi_newtree4->Branch("belectron_p_jetrestf",&belectron_p_jetrestf);
  jhchoi_newtree4->Branch("belectron_dR_l_j",&belectron_dR_l_j);
  jhchoi_newtree4->Branch("belectron_nsip3d",&belectron_nsip3d);
  jhchoi_newtree4->Branch("belectron_reltrkiso",&belectron_reltrkiso);
  jhchoi_newtree4->Branch("belectron_reliso",&belectron_reliso);
  jhchoi_newtree4->Branch("belectron_charge",&belectron_charge);
  jhchoi_newtree4->Branch("belectron_elecalclusteriso",&belectron_elecalclusteriso);
  jhchoi_newtree4->Branch("belectron_IsGsfCtfScPixChargeConsistent",&belectron_IsGsfCtfScPixChargeConsistent);
...
void ForLepJetChargeReliability::InitTreeValues(){
...
void ForLepJetChargeReliability::initializeAnalyzer(){
}

ForLepJetChargeReliability::~ForLepJetChargeReliability(){

  //==== Destructor of this Analyzer

}

bool ForLepJetChargeReliability::Tag_gbToZb(){
  LHEs=GetLHEs();
  ForLepJetChargeReliability::myLHE.LHEsize = LHEs.size();  
...
int ForLepJetChargeReliability::CheckIsBhadAndNb(int pid){
...
void ForLepJetChargeReliability::Tag_B_Hadron(){
  //init
...
void ForLepJetChargeReliability::Loop_genBMatchedRecoJet(){
  //init
...
void ForLepJetChargeReliability::AnalyzeGEN(){
  //[TODO]
...
void ForLepJetChargeReliability::AnalyzeLHE(){
  //[TODO]
...
bool ForLepJetChargeReliability::ZTagCuts(){
  //[1]---Z -> ll tag--//
...
int ForLepJetChargeReliability::Rank1n2Leptons(std::vector<int> &v_blep_idx, std::vector<double> &v_blep_value){
  double center=1.7;
...
void ForLepJetChargeReliability::FillHistMuon(TString cutname){
...
void ForLepJetChargeReliability::FillHistMuonCharge(TString cutname){
...
void ForLepJetChargeReliability::RunLeptonCutStudyMuon(){
...
void ForLepJetChargeReliability::SetTreeValuesMuon(vector<int> vmuonidx){
  ...
  for(int i=0; i < nbmuon; i++){
    ...
    bmuon_charge=AllMuons[i_bmuon].Charge();
...
void ForLepJetChargeReliability::FillHistElectron(TString cutname){
...
void ForLepJetChargeReliability::FillHistElectronCharge(TString cutname){
...
void ForLepJetChargeReliability::RunLeptonCutStudyElectron(){
  TString CutStudyEventTag=EventTag;
  CutStudyEventTag="CutStudy__"+CutStudyEventTag;
  TString CutStudyEventTagJetParton=EventTagJetParton;
  CutStudyEventTagJetParton="CutStudy__"+CutStudyEventTagJetParton;
...
void ForLepJetChargeReliability::SetTreeValuesElectron(vector<int> velectronidx){
  ...
  for(int i=0; i < nbelectron; i++){
    ...
    belectron_IsGsfCtfScPixChargeConsistent=AllElectrons[i_belectron].IsGsfCtfScPixChargeConsistent();
    ...
    belectron_charge=AllElectrons[i_belectron].Charge();
...
void ForLepJetChargeReliability::AnalyzeRECO(){
  ...
  bool isGoodZ=ForLepJetChargeReliability::ZTagCuts();
  if(!isGoodZ) return;
  ...
  //ForLepJetChargeReliability::RunProtoTypeMuon();
  //ForLepJetChargeReliability::RunProtoTypeElectron();
  ForLepJetChargeReliability::RunLeptonCutStudyMuon();
  ForLepJetChargeReliability::RunLeptonCutStudyElectron();
  

}

void ForLepJetChargeReliability::executeEvent(){
  //isEvenEvent=((event%2)==0);
  if((event%4==1)||(event%4==2)){
    isEventGroup1=true;
    isEventGroup2=false;
  }
  else{
  ...
  myLHE.is_gbToZb = ForLepJetChargeReliability::Tag_gbToZb(); 
  ...
  // if b event : ForLepJetChargeReliability::myLHE.evt_nb=1
  // if bbar event : ForLepJetChargeReliability::myLHE.evt_nb=-1

  //(2)---Get the most energetic B-hadron info. in GEN
  ForLepJetChargeReliability::Tag_B_Hadron();
  //->For GEN particles 
  //  -> Tag All B hadron and get the most energetic B-hadron info.
  
  //(3)---Check Jet matching to B-hadron
  ForLepJetChargeReliability::Loop_genBMatchedRecoJet();


  //(4)---Now basic generator level info is set. do analysis//fill histograms
  ForLepJetChargeReliability::AnalyzeLHE();
  ForLepJetChargeReliability::AnalyzeGEN();
  if(!myRECO.HasBmatchedRecoJet) return; // if there's no bmatjet->return
  if(!(1==myRECO.nBmatJet)) return;
  ForLepJetChargeReliability::AnalyzeRECO();
  //NowFillTree
  doFillTree=true;//inclusive Tree
  if(doFillTree){
    ...
    if((bjetPartonFlavourCharge==bmuon_charge) || (bjetPartonFlavourCharge==belectron_charge) || (bjetPartonFlavourCharge*bjet_charge > 0) ){
      if(isEventGroup1){
	jhchoi_newtree->Fill();
      }
      else if(isEventGroup2){
