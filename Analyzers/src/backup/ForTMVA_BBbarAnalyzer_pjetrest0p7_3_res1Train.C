#include "ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train.h"


ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train::ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train(){//FYI : bottomness = -nb
...
void ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train::InitTreeValues(){
...
void ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train::initializeAnalyzer(){
  /*
  ...
  */
  ...
  cout << "[ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train::initializeAnalyzer] RunSyst = " << RunSyst << endl;
  ...
  cout << "[ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train::initializeAnalyzer Setting ProcessName = " << ProcessName << endl;


  //==== (Example) Year-dependent variables
  //==== I defined "TString IsoMuTriggerName;" and "double TriggerSafePtCut;" in Analyzers/include/ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train.h 
  ...
  cout << "[ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train::initializeAnalyzer] RunNewPDF = " << RunNewPDF << endl;
  if(RunNewPDF && !IsDATA){
  ...
  cout << "[ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train::initializeAnalyzer] RunXSecSyst = " << RunXSecSyst << endl;

}

ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train::~ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train(){

  //==== Destructor of this Analyzer

}

bool ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train::Tag_gbToZb(){
  LHEs=GetLHEs();
  ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train::myLHE.LHEsize = LHEs.size();  
...
int ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train::CheckIsBhadAndNb(int pid){
...
void ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train::Tag_B_Hadron(){
  //init
...
void ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train::Loop_genBMatchedRecoJet(){
  //init
...
}//[END]ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train::Loop_genBMatchedRecoJet()
...
void ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train::AnalyzeGEN(){
  //[TODO]
...
void ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train::AnalyzeLHE(){
  //[TODO]
...
bool ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train::ZTagCuts(){
  //[1]---Z -> ll tag--//
...
int ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train::Rank1n2Leptons(std::vector<int> &v_blep_idx, std::vector<double> &v_blep_value){
  double center=1.7;
...
void ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train::FillHistMuon(TString cutname){
...
void ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train::FillHistMuonCharge(TString cutname){
...
void ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train::RunLeptonCutStudyMuon(){
...
void ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train::SetTreeValuesMuon(int i_bmuon1,int i_bmuon2,int nbmuon){
  doFillTree=true;
  //--p jetrestf
...
void ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train::FillHistElectron(TString cutname){
...
void ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train::FillHistElectronCharge(TString cutname){
...
void ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train::RunLeptonCutStudyElectron(){
  TString CutStudyEventTag=EventTag;
  CutStudyEventTag="CutStudy__"+CutStudyEventTag;
  TString CutStudyEventTagJetParton=EventTagJetParton;
  CutStudyEventTagJetParton="CutStudy__"+CutStudyEventTagJetParton;
...
void ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train::SetTreeValuesElectron(int i_belectron1,int i_belectron2,int nbelectron){
  doFillTree=true;
  //--p jetrestf
...
void ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train::AnalyzeRECO(){
  ...
  bool isGoodZ=ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train::ZTagCuts();
  if(!isGoodZ) return;
  ...
  //ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train::RunProtoTypeMuon();
  //ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train::RunProtoTypeElectron();
  ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train::RunLeptonCutStudyMuon();
  ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train::RunLeptonCutStudyElectron();
  

}

void ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train::executeEvent(){
  EventTag="";
  EventTagJetParton="";
  doPrint=false;
  ...
  myLHE.is_gbToZb = ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train::Tag_gbToZb(); 
  ...
  // if b event : ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train::myLHE.evt_nb=1
  // if bbar event : ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train::myLHE.evt_nb=-1

  //(2)---Get the most energetic B-hadron info. in GEN
  ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train::Tag_B_Hadron();
  //->For GEN particles 
  //  -> Tag All B hadron and get the most energetic B-hadron info.
  
  //(3)---Check Jet matching to B-hadron
  ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train::Loop_genBMatchedRecoJet();


  //(4)---Now basic generator level info is set. do analysis//fill histograms
  ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train::AnalyzeLHE();
  ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train::AnalyzeGEN();
  if(!myRECO.HasBmatchedRecoJet) return; // if there's no bmatjet->return
  if(!(1==myRECO.nBmatJet)) return;
  ForTMVA_BBbarAnalyzer_pjetrest0p7_3_res1Train::AnalyzeRECO();
  //NowFillTree
  if(doFillTree){
