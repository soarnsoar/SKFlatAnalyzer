#include "ForTMVA_BBbarAnalyzer_lepV1.h"


ForTMVA_BBbarAnalyzer_lepV1::ForTMVA_BBbarAnalyzer_lepV1(){//FYI : bottomness = -nb
...
void ForTMVA_BBbarAnalyzer_lepV1::InitTreeValues(){
...
void ForTMVA_BBbarAnalyzer_lepV1::initializeAnalyzer(){
  /*
  ...
  */
  ...
  cout << "[ForTMVA_BBbarAnalyzer_lepV1::initializeAnalyzer] RunSyst = " << RunSyst << endl;
  ...
  cout << "[ForTMVA_BBbarAnalyzer_lepV1::initializeAnalyzer Setting ProcessName = " << ProcessName << endl;


  //==== (Example) Year-dependent variables
  //==== I defined "TString IsoMuTriggerName;" and "double TriggerSafePtCut;" in Analyzers/include/ForTMVA_BBbarAnalyzer_lepV1.h 
  ...
  cout << "[ForTMVA_BBbarAnalyzer_lepV1::initializeAnalyzer] RunNewPDF = " << RunNewPDF << endl;
  if(RunNewPDF && !IsDATA){
  ...
  cout << "[ForTMVA_BBbarAnalyzer_lepV1::initializeAnalyzer] RunXSecSyst = " << RunXSecSyst << endl;

}

ForTMVA_BBbarAnalyzer_lepV1::~ForTMVA_BBbarAnalyzer_lepV1(){

  //==== Destructor of this Analyzer

}

bool ForTMVA_BBbarAnalyzer_lepV1::Tag_gbToZb(){
  LHEs=GetLHEs();
  ForTMVA_BBbarAnalyzer_lepV1::myLHE.LHEsize = LHEs.size();  
...
int ForTMVA_BBbarAnalyzer_lepV1::CheckIsBhadAndNb(int pid){
...
void ForTMVA_BBbarAnalyzer_lepV1::Tag_B_Hadron(){
  //init
...
void ForTMVA_BBbarAnalyzer_lepV1::Loop_genBMatchedRecoJet(){
  //init
...
}//[END]ForTMVA_BBbarAnalyzer_lepV1::Loop_genBMatchedRecoJet()
...
void ForTMVA_BBbarAnalyzer_lepV1::AnalyzeGEN(){
  //[TODO]
...
void ForTMVA_BBbarAnalyzer_lepV1::AnalyzeLHE(){
  //[TODO]
...
bool ForTMVA_BBbarAnalyzer_lepV1::ZTagCuts(){
  //[1]---Z -> ll tag--//
...
int ForTMVA_BBbarAnalyzer_lepV1::Rank1n2Leptons(std::vector<int> &v_blep_idx, std::vector<double> &v_blep_value){
  double center=1.7;
...
void ForTMVA_BBbarAnalyzer_lepV1::FillHistMuon(TString cutname){
...
void ForTMVA_BBbarAnalyzer_lepV1::FillHistMuonCharge(TString cutname){
...
void ForTMVA_BBbarAnalyzer_lepV1::RunLeptonCutStudyMuon(){
...
void ForTMVA_BBbarAnalyzer_lepV1::SetTreeValuesMuon(int i_bmuon1,int i_bmuon2,int nbmuon){
  doFillTree=true;
  //--p jetrestf
...
void ForTMVA_BBbarAnalyzer_lepV1::FillHistElectron(TString cutname){
...
void ForTMVA_BBbarAnalyzer_lepV1::FillHistElectronCharge(TString cutname){
...
void ForTMVA_BBbarAnalyzer_lepV1::RunLeptonCutStudyElectron(){
  TString CutStudyEventTag=EventTag;
  CutStudyEventTag="CutStudy__"+CutStudyEventTag;
  TString CutStudyEventTagJetParton=EventTagJetParton;
  CutStudyEventTagJetParton="CutStudy__"+CutStudyEventTagJetParton;
...
void ForTMVA_BBbarAnalyzer_lepV1::SetTreeValuesElectron(int i_belectron1,int i_belectron2,int nbelectron){
  doFillTree=true;
  //--p jetrestf
...
void ForTMVA_BBbarAnalyzer_lepV1::AnalyzeRECO(){
  ...
  bool isGoodZ=ForTMVA_BBbarAnalyzer_lepV1::ZTagCuts();
  if(!isGoodZ) return;
  ...
  //ForTMVA_BBbarAnalyzer_lepV1::RunProtoTypeMuon();
  //ForTMVA_BBbarAnalyzer_lepV1::RunProtoTypeElectron();
  ForTMVA_BBbarAnalyzer_lepV1::RunLeptonCutStudyMuon();
  ForTMVA_BBbarAnalyzer_lepV1::RunLeptonCutStudyElectron();
  

}

void ForTMVA_BBbarAnalyzer_lepV1::executeEvent(){
  EventTag="";
  EventTagJetParton="";
  doPrint=false;
  ...
  myLHE.is_gbToZb = ForTMVA_BBbarAnalyzer_lepV1::Tag_gbToZb(); 
  ...
  // if b event : ForTMVA_BBbarAnalyzer_lepV1::myLHE.evt_nb=1
  // if bbar event : ForTMVA_BBbarAnalyzer_lepV1::myLHE.evt_nb=-1

  //(2)---Get the most energetic B-hadron info. in GEN
  ForTMVA_BBbarAnalyzer_lepV1::Tag_B_Hadron();
  //->For GEN particles 
  //  -> Tag All B hadron and get the most energetic B-hadron info.
  
  //(3)---Check Jet matching to B-hadron
  ForTMVA_BBbarAnalyzer_lepV1::Loop_genBMatchedRecoJet();


  //(4)---Now basic generator level info is set. do analysis//fill histograms
  ForTMVA_BBbarAnalyzer_lepV1::AnalyzeLHE();
  ForTMVA_BBbarAnalyzer_lepV1::AnalyzeGEN();
  if(!myRECO.HasBmatchedRecoJet) return; // if there's no bmatjet->return
  if(!(1==myRECO.nBmatJet)) return;
  ForTMVA_BBbarAnalyzer_lepV1::AnalyzeRECO();
  //NowFillTree
  if(doFillTree){
