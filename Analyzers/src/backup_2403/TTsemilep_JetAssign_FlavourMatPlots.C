#include "TTsemilep_JetAssign_FlavourMatPlots.h"
#include <stdlib.h>
#include <stdio.h>

TTsemilep_JetAssign_FlavourMatPlots::TTsemilep_JetAssign_FlavourMatPlots(){//
...
void TTsemilep_JetAssign_FlavourMatPlots::InitValues(){
...
void TTsemilep_JetAssign_FlavourMatPlots::initializeAnalyzer(){
  ...
  */
  ...
  cout << "[TTsemilep_JetAssign_FlavourMatPlots::initializeAnalyzer Setting ProcessName = " << ProcessName << endl;
...
void TTsemilep_JetAssign_FlavourMatPlots::AnalyzeLHE(){
...
void TTsemilep_JetAssign_FlavourMatPlots::AnalyzeGEN(){
  GENs=GetGens();
...
bool TTsemilep_JetAssign_FlavourMatPlots::TTbarMuReco(){
...
bool TTsemilep_JetAssign_FlavourMatPlots::TTbarElReco(){
...
bool TTsemilep_JetAssign_FlavourMatPlots::CheckJets(){
...
void TTsemilep_JetAssign_FlavourMatPlots::AnalyzeRECO(){
  ...
  ///--Using btag score--//
  if(!TTsemilep_JetAssign_FlavourMatPlots::CheckJets()) return;
...
void TTsemilep_JetAssign_FlavourMatPlots::FillTreeValues(){
...
void TTsemilep_JetAssign_FlavourMatPlots::executeEvent(){
  if(doReduction){
  ...
  LHEs=GetLHEs();
  TTsemilep_JetAssign_FlavourMatPlots::AnalyzeLHE();
  if (myLHE.IsTauChannel) return; // not caring tau channel
  if(ProcessName.Contains("TTLJ"))TTsemilep_JetAssign_FlavourMatPlots::AnalyzeGEN();
  //FillCutflow("cutflow/all/"+ProcessName,"event_start",weight);
  FillHist("event_start/cutflow/"+ProcessName,1, weight, 2, 0, 2);
  TTsemilep_JetAssign_FlavourMatPlots::AnalyzeRECO();
  //if(doFillTree) TTsemilep_JetAssign_FlavourMatPlots::FillTreeValues();
