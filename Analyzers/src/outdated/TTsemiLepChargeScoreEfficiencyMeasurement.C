...
void TTsemiLepChargeScoreEfficiencyMeasurement::FillHistBJet(TString cutname, int bjetidx){
  ...
  //and lepton pt
  //FillHist(cutname+"/lep_pt", l1.Pt(),weight,100,0,300);
  //FillHist(cutname+"/lep_eta", l1.Eta(),weight,50,-3,3);  

  if(bpt100){
    if(v_tightjet[bjetidx].Pt()>100.){
      FillHist(cutname+"_bPtOver100/bjet_pt", v_tightjet[bjetidx].Pt(),weight,50,0,100);
      FillHist(cutname+"_bPtOver100/bjet_eta", v_tightjet[bjetidx].Eta(),weight,50,-3,3);
      //FillHist(cutname+"_bPtOver100/lep_pt", l1.Pt(),weight,100,0,300);
      //FillHist(cutname+"_bPtOver100/lep_eta", l1.Eta(),weight,50,-3,3);  
    }
    else{
      FillHist(cutname+"_bPtUnder100/bjet_pt", v_tightjet[bjetidx].Pt(),weight,50,100,300);
      FillHist(cutname+"_bPtUnder100/bjet_eta", v_tightjet[bjetidx].Eta(),weight,50,-3,3);
      //FillHist(cutname+"_bPtUnder100/lep_pt", l1.Pt(),weight,100,0,300);
      //FillHist(cutname+"_bPtUnder100/lep_eta", l1.Eta(),weight,50,-3,3);  
    }
...
void TTsemiLepChargeScoreEfficiencyMeasurement::FillHistBJetMuonMax(TString cutname, int bjetidx){
  ...
  if(bpt100){
    if(v_tightjet[bjetidx].Pt()>100.){
      FillHist(cutname+"_bPtOver100/muonmax_ptwrtjet", ptwrtjet,weight,100,0,100);
      FillHist(cutname+"_bPtOver100/muonmax_ptAtJetRest", ptAtJetRest,weight,100,0,100);
      FillHist(cutname+"_bPtOver100/muonmax_score", current_bmuon_score_max,weight,100,0,1);
    }
    else{
      FillHist(cutname+"_bPtUnder100/muonmax_ptwrtjet", ptwrtjet,weight,100,0,100);
      FillHist(cutname+"_bPtUnder100/muonmax_ptAtJetRest", ptAtJetRest,weight,100,0,100);
      FillHist(cutname+"_bPtUnder100/muonmax_score", current_bmuon_score_max,weight,100,0,1);
    }
  }
}
...
void TTsemiLepChargeScoreEfficiencyMeasurement::FillHistBJetMuonMin(TString cutname, int bjetidx){
  ...
  if(bpt100){
    if(v_tightjet[bjetidx].Pt()>100.){
      FillHist(cutname+"_bPtOver100/muonmin_ptwrtjet", ptwrtjet,weight,100,0,100);
      FillHist(cutname+"_bPtOver100/muonmin_ptAtJetRest", ptAtJetRest,weight,100,0,100);
      FillHist(cutname+"_bPtOver100/muonmin_score", current_bmuon_score_min,weight,100,0,1);
    }
    else{
      FillHist(cutname+"_bPtUnder100/muonmin_ptwrtjet", ptwrtjet,weight,100,0,100);
      FillHist(cutname+"_bPtUnder100/muonmin_ptAtJetRest", ptAtJetRest,weight,100,0,100);
      FillHist(cutname+"_bPtUnder100/muonmin_score", current_bmuon_score_min,weight,100,0,1);
    }
...
void TTsemiLepChargeScoreEfficiencyMeasurement::FillHistBJetElectronMax(TString cutname, int bjetidx){
  ...
  if(bpt100){
    if(v_tightjet[bjetidx].Pt()>100.){
      FillHist(cutname+"_bPtOver100/electronmax_ptwrtjet", ptwrtjet,weight,100,0,100);
      FillHist(cutname+"_bPtOver100/electronmax_ptAtJetRest", ptAtJetRest,weight,100,0,100);
      FillHist(cutname+"_bPtOver100/electronmax_score", current_belectron_score_max,weight,100,0,1);
    }
    else{
      FillHist(cutname+"_bPtUnder100/electronmax_ptwrtjet", ptwrtjet,weight,100,0,100);
      FillHist(cutname+"_bPtUnder100/electronmax_ptAtJetRest", ptAtJetRest,weight,100,0,100);
      FillHist(cutname+"_bPtUnder100/electronmax_score", current_belectron_score_max,weight,100,0,1);
    }
...
void TTsemiLepChargeScoreEfficiencyMeasurement::FillHistBJetElectronMin(TString cutname, int bjetidx){
  ...
  if(bpt100){
    if(v_tightjet[bjetidx].Pt()>100.){
      FillHist(cutname+"_bPtOver100/electronmin_ptwrtjet", ptwrtjet,weight,100,0,100);
      FillHist(cutname+"_bPtOver100/electronmin_ptAtJetRest", ptAtJetRest,weight,100,0,100);
      FillHist(cutname+"_bPtOver100/electronmin_score", current_belectron_score_min,weight,100,0,1);
    }
    else{
      FillHist(cutname+"_bPtUnder100/electronmin_ptwrtjet", ptwrtjet,weight,100,0,100);
      FillHist(cutname+"_bPtUnder100/electronmin_ptAtJetRest", ptAtJetRest,weight,100,0,100);
      FillHist(cutname+"_bPtUnder100/electronmin_score", current_belectron_score_min,weight,100,0,1);
    }
