#include "TTsemilep_LeptonChargeAccuracy.h"
#include <stdlib.h>
#include <stdio.h>

TTsemilep_LeptonChargeAccuracy::TTsemilep_LeptonChargeAccuracy(){//
...
void TTsemilep_LeptonChargeAccuracy::initChargeReliabilityModel_muon(){
...
void TTsemilep_LeptonChargeAccuracy::initChargeReliabilityModel_electron(){
...
void TTsemilep_LeptonChargeAccuracy::initChargeReliabilityModel_jet(){
...
void TTsemilep_LeptonChargeAccuracy::initJetAssignModel_muon(){//TTsemilepJetAssign/2312/v1
...
void TTsemilep_LeptonChargeAccuracy::initJetAssignModel_electron(){//TTsemilepJetAssign/2312/v1
...
void TTsemilep_LeptonChargeAccuracy::InitValues(){
...
void TTsemilep_LeptonChargeAccuracy::initializeAnalyzer(){
  ...
  cout << "[TTsemilep_LeptonChargeAccuracy::initializeAnalyzer Setting ProcessName = " << ProcessName << endl;
...
void TTsemilep_LeptonChargeAccuracy::AnalyzeLHE(){
...
void TTsemilep_LeptonChargeAccuracy::AnalyzeGEN(){
  GENs=GetGens();
...
bool TTsemilep_LeptonChargeAccuracy::TTbarMuReco(){
  //Tag only 1 muon 
...
bool TTsemilep_LeptonChargeAccuracy::TTbarElReco(){
  //Tag only 1 electron 
...
bool TTsemilep_LeptonChargeAccuracy::CheckJets(){
...
void TTsemilep_LeptonChargeAccuracy::Check_bJet_Charge(){
  //---bHadJet
  TTsemilep_LeptonChargeAccuracy::Set_bJet(true);//set target bjet to bHad and eval relibilities
  //----bLepJet
  TTsemilep_LeptonChargeAccuracy::Set_bJet(false);//set target bjet to bLep and eval relibilities



  //ChannelLep
  FillHist(ChannelLep+"/TagLeptonCharge/"+ProcessName,myRECO.TagLeptonCharge,weight,4,-2,2);
  FillHist(ChannelLep+"/LHELeptonCharge/"+ProcessName,myLHE.LeptonCharge,weight,4,-2,2);
  FillHist(ChannelLep+"/diff_TagLeptonCharge_LHELeptonCharge/"+ProcessName,myRECO.TagLeptonCharge - myLHE.LeptonCharge,weight,6,-3,3);
  FillHist(ChannelLep+"/IsLeptonChargeCorrect/"+ProcessName,myLHE.LeptonCharge == myRECO.TagLeptonCharge,weight,4,-1,3);
  if(myLHE.LeptonCharge>0){
    FillHist(ChannelLep+"_LHE_Plus"+"/IsLeptonChargeCorrect/"+ProcessName,myLHE.LeptonCharge == myRECO.TagLeptonCharge,weight,4,-1,3);
  }
  else{
    FillHist(ChannelLep+"_LHE_Minus"+"/IsLeptonChargeCorrect/"+ProcessName,myLHE.LeptonCharge == myRECO.TagLeptonCharge,weight,4,-1,3);
  }

  if(myRECO.TagLeptonCharge>0){
    FillHist(ChannelLep+"_Measure_Plus"+"/IsLeptonChargeCorrect/"+ProcessName,myLHE.LeptonCharge == myRECO.TagLeptonCharge,weight,4,-1,3);
  }
  else{
    FillHist(ChannelLep+"_Measure_Minus"+"/IsLeptonChargeCorrect/"+ProcessName,myLHE.LeptonCharge == myRECO.TagLeptonCharge,weight,4,-1,3);
  }
  //  //FillHist("2b_over2j/Thad_M/"+ProcessName,Thad_dnn.M(), weight, 100, 0, 350);
...
TLorentzVector TTsemilep_LeptonChargeAccuracy::GetTransverseVector(TLorentzVector v){
...
TLorentzVector TTsemilep_LeptonChargeAccuracy::GetTransverseVector(double pt, double phi){
...
void TTsemilep_LeptonChargeAccuracy::FillHist_bJet(TString cutname){
...
void TTsemilep_LeptonChargeAccuracy::FillHist_LeptonicTopSide(TString cutname){
...
void TTsemilep_LeptonChargeAccuracy::FillHist_HadronicTopSide(TString cutname){
...
void TTsemilep_LeptonChargeAccuracy::FillHist_bHadJet(TString cutname){
...
void TTsemilep_LeptonChargeAccuracy::FillHist_bLepJet(TString cutname){
...
void TTsemilep_LeptonChargeAccuracy::FillHist_bmuon_in_bHad(TString cutname){
...
void TTsemilep_LeptonChargeAccuracy::FillHist_bmuon_in_bLep(TString cutname){
...
void TTsemilep_LeptonChargeAccuracy::FillHist_belectron_in_bHad(TString cutname){
...
void TTsemilep_LeptonChargeAccuracy::FillHist_belectron_in_bLep(TString cutname){
...
void TTsemilep_LeptonChargeAccuracy::Set_bJet(bool Is_bHad){
  ...
  TTsemilep_LeptonChargeAccuracy::Check_bMuonScore();
  //---After set bjet input, set belectron input and eval relib. of belectron charge 
  TTsemilep_LeptonChargeAccuracy::Check_bElectronScore();
...
void TTsemilep_LeptonChargeAccuracy::Check_bMuonScore(){
  //--Check bMuon--
...
void TTsemilep_LeptonChargeAccuracy::Check_bElectronScore(){
  //--Check bElectron--
  bool IsExist=false;
...
void TTsemilep_LeptonChargeAccuracy::AnalyzeRECO(){
  //call muon/electron
...
void TTsemilep_LeptonChargeAccuracy::executeEvent(){
  ...
  LHEs=GetLHEs();
  if(ProcessName.Contains("TTLJ"))TTsemilep_LeptonChargeAccuracy::AnalyzeLHE();
  //if (myLHE.IsTauChannel) return; // not caring tau channel
  if(ProcessName.Contains("TTLJ"))TTsemilep_LeptonChargeAccuracy::AnalyzeGEN();
  //FillCutflow("cutflow/all/"+ProcessName,"event_start",weight);
  
  TTsemilep_LeptonChargeAccuracy::AnalyzeRECO();
