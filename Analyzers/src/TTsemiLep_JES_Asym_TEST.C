#include "TTsemiLep_JES_Asym_TEST.h"

TTsemiLep_JES_Asym_TEST::TTsemiLep_JES_Asym_TEST(){
  //runSys=true;
  //jetpog_etabins
  //jetpog_ptbins
}
...
void TTsemiLep_JES_Asym_TEST::initializeAnalyzer(){
  cout << "[TTsemiLep_JES_Asym_TEST::initializeAnalyzer]" << endl;
  ...
  if(HasFlag("use_beff")){
    ...
    //if(!IsDATA) AnalyzerCore::SetBTagMCEff_Filename("TTsemiLep_JES_Asym_TEST_"+MCSample+".root");
...
void TTsemiLep_JES_Asym_TEST::SetMuon(const Muon& _l1){
  mu1=_l1;
}

bool TTsemiLep_JES_Asym_TEST::CheckIsMuonChannel(){
...
void TTsemiLep_JES_Asym_TEST::SetElectron(const Electron& _l1){
  el1=_l1;
}


bool TTsemiLep_JES_Asym_TEST::CheckIsElectronChannel(){
...
void TTsemiLep_JES_Asym_TEST::SetEventWeight(){
  weight=1;
  if(IsDATA) return;
...
void TTsemiLep_JES_Asym_TEST::RunReco(){
...
void TTsemiLep_JES_Asym_TEST::Run(){
  iblep=-1;
  ibhad=-1;
  iq1=-1;
  iq2=-1;
...
void TTsemiLep_JES_Asym_TEST::RunBJet(TString bjetname, int bjetidx, int bgenidx, TLorentzVector &Tcand){
...
TString TTsemiLep_JES_Asym_TEST::GetCutSuffix(double this_bjet_pt,double this_bjet_eta,bool ignore_etabin){
...
void TTsemiLep_JES_Asym_TEST::FillHistOtherObject(TString cutname){
  //if(runSys) return;
  //v_bjetidx
  //l1
  //CurrentMET.Pt()
...
void TTsemiLep_JES_Asym_TEST::FillHistBJet(TString cutname, int bjetidx,int bgenidx, TLorentzVector& Tcand){
...
void TTsemiLep_JES_Asym_TEST::SetTopAndW(){
...
void TTsemiLep_JES_Asym_TEST::EventLoop(){
  RunReco();
...
void TTsemiLep_JES_Asym_TEST::TruthLoop(){
  //it must be TTLJ samples
  if (IsTTLJSample){
    TTsemiLep_JES_Asym_TEST::RunLHEinfo();
    TTsemiLep_JES_Asym_TEST::RunGENinfo();
  }

}

void TTsemiLep_JES_Asym_TEST::RunLHEinfo(){
  //
  //initialize
...
void TTsemiLep_JES_Asym_TEST::RunGENinfo(){
