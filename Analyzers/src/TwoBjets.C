...
void TwoBjets::initializeAnalyzer(){
  cout << "[TwoBjets::initializeAnalyzer]" << endl;
...
void TwoBjets::SetMuon(const Muon& _l1){
  mu1=_l1;
}

bool TwoBjets::CheckIsMuonChannel(){
...
void TwoBjets::SetElectron(const Electron& _l1){
  el1=_l1;
}


bool TwoBjets::CheckIsElectronChannel(){
...
void TwoBjets::FillHistCommon(TString cutname){
...
void TwoBjets::FillHistAllB(TString cutname){
  for(auto &i_bjet : v_bjetidx){
...
void TwoBjets::FillHistBInfo(TString cutname, int i_bjet){
