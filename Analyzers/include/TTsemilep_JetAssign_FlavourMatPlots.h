#ifndef TTsemilep_JetAssign_FlavourMatPlots_h
#define TTsemilep_JetAssign_FlavourMatPlots_h
...
#include <set>
class TTsemilep_JetAssign_FlavourMatPlots : public AnalyzerCore {
...
public:
  ...
  TTsemilep_JetAssign_FlavourMatPlots();
  ~TTsemilep_JetAssign_FlavourMatPlots();
