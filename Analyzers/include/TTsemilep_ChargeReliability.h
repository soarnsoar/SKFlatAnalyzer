#ifndef TTsemilep_ChargeReliability_h
#define TTsemilep_ChargeReliability_h
...
#include <set>
class TTsemilep_ChargeReliability : public AnalyzerCore {
...
public:
  ...
  void SetProcessTagTTLJ();
  void AddProcessTagTTLJ();
  ...
  //For Categorize
  TString ChannelLep;
  TString bHadTrueMatchTag;
  TString bLepTrueMatchTag;
