#ifndef TTsemiLepChargeScoreEfficiencyMeasurement_TightMatch_h
#define TTsemiLepChargeScoreEfficiencyMeasurement_TightMatch_h

#include "JHAnalyzerBase.h"

class TTsemiLepChargeScoreEfficiencyMeasurement_TightMatch : public JHAnalyzerBase {
...
public:
  ...
  bool RunBJetMuon(TString bjetname, int bjetidx,int bgenidx, TLorentzVector &Tcand);
  bool Run_HasSoftMuon(int bjetidx);
  bool RunSLTMuonPassCutToMax();
  bool RunSLTMuonPassCutToMin();

  bool RunBJetElectron(TString bjetname, int bjetidx,int bgenidx,TLorentzVector &Tcand);
  bool Run_HasSoftElectron(int bjetidx);
  bool RunSLTElectronPassCutToMax();
  bool RunSLTElectronPassCutToMin();

  void RunBJetCharge(TString bjetname, int bjetidx,int bgenidx,TLorentzVector &Tcand);
