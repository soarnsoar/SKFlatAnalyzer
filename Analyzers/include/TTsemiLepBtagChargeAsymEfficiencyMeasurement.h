#ifndef TTsemiLepBtagChargeAsymEfficiencyMeasurement_h
#define TTsemiLepBtagChargeAsymEfficiencyMeasurement_h

#include "JHAnalyzerBase.h"

class TTsemiLepBtagChargeAsymEfficiencyMeasurement : public JHAnalyzerBase {
