#ifndef TTsemiLepChargeScoreEfficiencyMeasurement_partonFlavour_h
#define TTsemiLepChargeScoreEfficiencyMeasurement_partonFlavour_h

#include "JHAnalyzerBase.h"

class TTsemiLepChargeScoreEfficiencyMeasurement_partonFlavour : public JHAnalyzerBase {
...
public:
  ...
  void RunBJet(TString bjetname, int bjetidx, TLorentzVector& Tcand);
  
  bool RunBJetMuon(TString bjetname, int bjetidx, TLorentzVector &Tcand);
  bool Run_HasSoftMuon(int bjetidx);
  bool RunSLTMuonPassCutToMax();
  bool RunSLTMuonPassCutToMin();

  bool RunBJetElectron(TString bjetname, int bjetidx,TLorentzVector &Tcand);
  bool Run_HasSoftElectron(int bjetidx);
  bool RunSLTElectronPassCutToMax();
  bool RunSLTElectronPassCutToMin();

  void RunBJetCharge(TString bjetname, int bjetidx,TLorentzVector &Tcand);
  ...
  void FillHistBJet(TString cutname, int bjetidx, TLorentzVector &Tcand);
