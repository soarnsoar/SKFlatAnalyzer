#ifndef ForLepJetChargeReliabilityCoeff_h
#define ForLepJetChargeReliabilityCoeff_h
...
#include <set>
class ForLepJetChargeReliabilityCoeff : public AnalyzerCore {
...
public:
  ...
  ForLepJetChargeReliabilityCoeff();
  ~ForLepJetChargeReliabilityCoeff();
