...
#include <set>
class HZZ_test : public AnalyzerCore {
...
public:
  ...
  bool ZZmmmmReco();
  int idx_z1_p,idx_z1_m,idx_z2_p,idx_z2_m;
  TLorentzVector z1,z2,hcand; 
  bool ZZeeeeReco();
  bool ZZmmeeReco();
  ...
  struct RECOinfo{
    ...
    bool goodZZmmee;
    bool goodZZeeee;
    bool passMuonTriggerAndZZmmmm;
    bool passElectronTriggerAndZZeeee;
