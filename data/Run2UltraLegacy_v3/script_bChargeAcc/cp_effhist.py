...
ANANAME="TTsemiLepChargeScoreAccuracyMeasurement"
#suffix="use_beff_dasym__JETPUID_L__bdt2512.5__measure_bchargeeff__"
suffix="use_beff_dasym__JETPUID_L__chi2kincut__bdt2512.5__splitcharge__noetabin__measure_bchargeacc__"
for YEAR in list_year:
    ...
    to_dir=SKFlat_WD+"/data/Run2UltraLegacy_v3/"+str(YEAR)+"/bChargeAcc/"
