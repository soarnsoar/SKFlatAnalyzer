...
ANANAME="bbbarAsymMeasurement"
for YEAR in list_year:
    from_dir="/data6/Users/jhchoi/SKFlatOutput/Run2UltraLegacy_v3/"+ANANAME+"/"+str(YEAR)+"/measure_bchargeeff__"
    to_dir=SKFlat_WD+"/data/Run2UltraLegacy_v3/"+str(YEAR)+"/BChargeEff/"
    os.system("mkdir -p "+to_dir)
