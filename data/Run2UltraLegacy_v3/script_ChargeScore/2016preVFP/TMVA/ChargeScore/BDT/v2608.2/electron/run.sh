...
eval `scramv1 ru -sh`
cd /data9/Users/jhchoi/Generate_BDT_Model/TMVA_TOOL/ws/WORKDIR_FIN/2608.2/2016preVFP/electron/G/Grad/Shrinkage__0.005/NTrees__800/MaxDepth__4/MinNodeSize__1/UseBaggedBoost__True/BaggedSampleFraction__0.1/SeparationType__CrossEntropy/nCuts__10/IgnoreNegWeightsInTraining__True
(cd /data9/Users/jhchoi/Generate_BDT_Model/TMVA_TOOL/ws&&cd WORKDIR_FIN/2608.2/2016preVFP/electron/G/Grad/Shrinkage__0.005/NTrees__800/MaxDepth__4/MinNodeSize__1/UseBaggedBoost__True/BaggedSampleFraction__0.1/SeparationType__CrossEntropy/nCuts__10/IgnoreNegWeightsInTraining__True&&python3 /data9/Users/jhchoi/Generate_BDT_Model/TMVA_TOOL/script/BDT/run_single_BDT.py  --transform G --BoostType Grad --Shrinkage 0.005 --NTrees 800 --MaxDepth 4 --MinNodeSize 1 --UseBaggedBoost True --BaggedSampleFraction 0.1 --SeparationType CrossEntropy --nCuts 10 --IgnoreNegWeightsInTraining True --analyzer EEMu_MuMuE_Method --version 2608.2 --name BDT_2016preVFP --year 2016preVFP --channel electron)
myerr=$?
ntry=1
echo "myerr=$myerr"
while [ $myerr -ne 0 ]
...
if [ $myerr -eq 0 ]
then
mv /data9/Users/jhchoi/Generate_BDT_Model/TMVA_TOOL/ws/WORKDIR_FIN/2608.2/2016preVFP/electron/G/Grad/Shrinkage__0.005/NTrees__800/MaxDepth__4/MinNodeSize__1/UseBaggedBoost__True/BaggedSampleFraction__0.1/SeparationType__CrossEntropy/nCuts__10/IgnoreNegWeightsInTraining__True/run.jid /data9/Users/jhchoi/Generate_BDT_Model/TMVA_TOOL/ws/WORKDIR_FIN/2608.2/2016preVFP/electron/G/Grad/Shrinkage__0.005/NTrees__800/MaxDepth__4/MinNodeSize__1/UseBaggedBoost__True/BaggedSampleFraction__0.1/SeparationType__CrossEntropy/nCuts__10/IgnoreNegWeightsInTraining__True/run.done
fi
