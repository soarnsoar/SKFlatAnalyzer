...
eval `scramv1 ru -sh`
cd /data9/Users/jhchoi/Generate_BDT_Model/TMVA_TOOL/ws/WORKDIR_FIN/2608.2/2016postVFP/muon/I/Grad/Shrinkage__0.005/NTrees__500/MaxDepth__4/MinNodeSize__0.1/UseBaggedBoost__True/BaggedSampleFraction__0.2/SeparationType__CrossEntropy/nCuts__50/IgnoreNegWeightsInTraining__True
(cd /data9/Users/jhchoi/Generate_BDT_Model/TMVA_TOOL/ws&&cd WORKDIR_FIN/2608.2/2016postVFP/muon/I/Grad/Shrinkage__0.005/NTrees__500/MaxDepth__4/MinNodeSize__0.1/UseBaggedBoost__True/BaggedSampleFraction__0.2/SeparationType__CrossEntropy/nCuts__50/IgnoreNegWeightsInTraining__True&&python3 /data9/Users/jhchoi/Generate_BDT_Model/TMVA_TOOL/script/BDT/run_single_BDT.py  --transform I --BoostType Grad --Shrinkage 0.005 --NTrees 500 --MaxDepth 4 --MinNodeSize 0.1 --UseBaggedBoost True --BaggedSampleFraction 0.2 --SeparationType CrossEntropy --nCuts 50 --IgnoreNegWeightsInTraining True --analyzer EEMu_MuMuE_Method --version 2608.2 --name BDT_2016postVFP --year 2016postVFP --channel muon)
myerr=$?
ntry=1
echo "myerr=$myerr"
while [ $myerr -ne 0 ]
...
if [ $myerr -eq 0 ]
then
mv /data9/Users/jhchoi/Generate_BDT_Model/TMVA_TOOL/ws/WORKDIR_FIN/2608.2/2016postVFP/muon/I/Grad/Shrinkage__0.005/NTrees__500/MaxDepth__4/MinNodeSize__0.1/UseBaggedBoost__True/BaggedSampleFraction__0.2/SeparationType__CrossEntropy/nCuts__50/IgnoreNegWeightsInTraining__True/run.jid /data9/Users/jhchoi/Generate_BDT_Model/TMVA_TOOL/ws/WORKDIR_FIN/2608.2/2016postVFP/muon/I/Grad/Shrinkage__0.005/NTrees__500/MaxDepth__4/MinNodeSize__0.1/UseBaggedBoost__True/BaggedSampleFraction__0.2/SeparationType__CrossEntropy/nCuts__50/IgnoreNegWeightsInTraining__True/run.done
fi
