...
eval `scramv1 ru -sh`
cd /data9/Users/jhchoi/TMVA/el9/TMVA_TOOL/ws/WORKDIR/2503.1/EEMu_MuMuE_Method/2018/electron/electron2018__5__64__500__0.2/Trf_G
(cd /data9/Users/jhchoi/TMVA/el9/TMVA_TOOL/ws&&cd WORKDIR/2503.1/EEMu_MuMuE_Method/2018/electron/electron2018__5__64__500__0.2/Trf_G&&python3 /data9/Users/jhchoi/TMVA/el9/TMVA_TOOL/script/run_single.py --name electron2018__5__64__500__0.2 --nlayer 5 --nnode 64 --batchsize 500 --dropout 0.2 --nepoch 300 --version 2503.1 --channel electron --year 2018 --analyzer EEMu_MuMuE_Method --transform G)
myerr=$?
ntry=1
echo "myerr=$myerr"
while [ $myerr -ne 0 ]
...
if [ $myerr -eq 0 ]
then
mv /data9/Users/jhchoi/TMVA/el9/TMVA_TOOL/ws/WORKDIR/2503.1/EEMu_MuMuE_Method/2018/electron/electron2018__5__64__500__0.2/Trf_G/run.jid /data9/Users/jhchoi/TMVA/el9/TMVA_TOOL/ws/WORKDIR/2503.1/EEMu_MuMuE_Method/2018/electron/electron2018__5__64__500__0.2/Trf_G/run.done
fi
