...
(python3 /u/user/jhchoi/bbbar_asym/dnn/TMVA_TOOL/script/BDT/run_single_BDT.py  --transform G --BoostType Grad --Shrinkage 0.05 --NTrees 400 --MaxDepth 5 --MinNodeSize 1 --UseBaggedBoost True --BaggedSampleFraction 0.7 --SeparationType GiniIndex --nCuts 20 --IgnoreNegWeightsInTraining True --analyzer EEMu_MuMuE_Method --version 2512.5_2018 --name FIN_BDT_2018 --year 2018 --channel jet&&ls)
myerr=$?
ntry=1
echo "myerr=$myerr"
while [ $myerr -ne 0 ]
