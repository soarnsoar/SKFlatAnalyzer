...
eval `scramv1 ru -sh`
cd /d0/scratch/jhchoi/v2409.2/WORKDIR/2409.2/EEMu_MuMuE_Method/2016postVFP/jet/jet2016postVFP__10__256__1000__0.2/Trf_N
(cd /d0/scratch/jhchoi/v2409.2&&cd WORKDIR/2409.2/EEMu_MuMuE_Method/2016postVFP/jet/jet2016postVFP__10__256__1000__0.2/Trf_N&&python /u/user/jhchoi/bbbar_asym/dnn/TMVA_TOOL/script/run_single.py --name jet2016postVFP__10__256__1000__0.2 --nlayer 10 --nnode 256 --batchsize 1000 --dropout 0.2 --nepoch 300 --version 2409.2 --channel jet --year 2016postVFP --analyzer EEMu_MuMuE_Method --transform N)
myerr=$?
ntry=1
echo "myerr=$myerr"
while [ $myerr -ne 0 ]
...
if [ $myerr -eq 0 ]
then
mv /d0/scratch/jhchoi/v2409.2/WORKDIR/2409.2/EEMu_MuMuE_Method/2016postVFP/jet/jet2016postVFP__10__256__1000__0.2/Trf_N/run.jid /d0/scratch/jhchoi/v2409.2/WORKDIR/2409.2/EEMu_MuMuE_Method/2016postVFP/jet/jet2016postVFP__10__256__1000__0.2/Trf_N/run.done
fi
