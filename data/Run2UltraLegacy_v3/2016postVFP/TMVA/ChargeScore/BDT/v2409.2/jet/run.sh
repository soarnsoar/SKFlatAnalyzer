...
eval `scramv1 ru -sh`
cd /u/user/jhchoi/bbbar_asym/dnn/TMVA_TOOL/ws/WORKDIR_FIN/2409.2/2016postVFP/jet/I__Grad__Shrinkage__0.01__NTrees__800__MaxDepth__5__MinNodeSize__0.1__UseBaggedBoost__True__BaggedSampleFraction__0.4__SeparationType__GiniIndex__nCuts__20__IgnoreNegWeightsInTraining__True/idx_0
(echo ${_CONDOR_SCRATCH_DIR}&&cd $_CONDOR_SCRATCH_DIR&&python3 /u/user/jhchoi/bbbar_asym/dnn/TMVA_TOOL/script/BDT/run_single_BDT.py  --transform I --BoostType Grad --Shrinkage 0.01 --NTrees 800 --MaxDepth 5 --MinNodeSize 0.1 --UseBaggedBoost True --BaggedSampleFraction 0.4 --SeparationType GiniIndex --nCuts 20 --IgnoreNegWeightsInTraining True --analyzer EEMu_MuMuE_Method --version 2409.2 --name FIN_BDT_2016postVFP --year 2016postVFP --channel jet&&ls)
myerr=$?
ntry=1
echo "myerr=$myerr"
while [ $myerr -ne 0 ]
