...
eval `scramv1 ru -sh`
cd /u/user/jhchoi/bbbar_asym/dnn/TMVA_TOOL/ws/WORKDIR_FIN/2409.2/2017/electron/U__Grad__Shrinkage__0.01__NTrees__500__MaxDepth__4__MinNodeSize__0.5__UseBaggedBoost__True__BaggedSampleFraction__0.2__SeparationType__GiniIndex__nCuts__50__IgnoreNegWeightsInTraining__True/idx_0
(echo ${_CONDOR_SCRATCH_DIR}&&cd $_CONDOR_SCRATCH_DIR&&python3 /u/user/jhchoi/bbbar_asym/dnn/TMVA_TOOL/script/BDT/run_single_BDT.py  --transform U --BoostType Grad --Shrinkage 0.01 --NTrees 500 --MaxDepth 4 --MinNodeSize 0.5 --UseBaggedBoost True --BaggedSampleFraction 0.2 --SeparationType GiniIndex --nCuts 50 --IgnoreNegWeightsInTraining True --analyzer EEMu_MuMuE_Method --version 2409.2 --name FIN_BDT_2017 --year 2017 --channel electron&&ls)
myerr=$?
ntry=1
echo "myerr=$myerr"
while [ $myerr -ne 0 ]
...
if [ $myerr -eq 0 ]
then
mv /u/user/jhchoi/bbbar_asym/dnn/TMVA_TOOL/ws/WORKDIR_FIN/2409.2/2017/electron/U__Grad__Shrinkage__0.01__NTrees__500__MaxDepth__4__MinNodeSize__0.5__UseBaggedBoost__True__BaggedSampleFraction__0.2__SeparationType__GiniIndex__nCuts__50__IgnoreNegWeightsInTraining__True/idx_0/run.jid /u/user/jhchoi/bbbar_asym/dnn/TMVA_TOOL/ws/WORKDIR_FIN/2409.2/2017/electron/U__Grad__Shrinkage__0.01__NTrees__500__MaxDepth__4__MinNodeSize__0.5__UseBaggedBoost__True__BaggedSampleFraction__0.2__SeparationType__GiniIndex__nCuts__50__IgnoreNegWeightsInTraining__True/idx_0/run.done
fi
