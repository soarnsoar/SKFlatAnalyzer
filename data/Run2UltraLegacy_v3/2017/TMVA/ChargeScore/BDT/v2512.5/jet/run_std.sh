...
do
ntry=`expr $ntry + 1`
(python3 /u/user/jhchoi/bbbar_asym/dnn/TMVA_TOOL/script/BDT/run_single_BDT.py  --transform G --BoostType Grad --Shrinkage 0.05 --NTrees 400 --MaxDepth 5 --MinNodeSize 1 --UseBaggedBoost False --BaggedSampleFraction 0 --SeparationType GiniIndex --nCuts 40 --IgnoreNegWeightsInTraining True --analyzer EEMu_MuMuE_Method --version 2512.5_2017 --name FIN_BDT_2017 --year 2017 --channel jet&&ls)
myerr=$?
echo ntry="$ntry"
echo "myerr=$myerr"
if [ $ntry -gt 1 ]
