...
year=sys.argv[1]
ID=sys.argv[2]
maindir="/data6/Users/jhchoi/SKFlatAnalyzers/test/ForTMVA/SKFlatAnalyzer/data/Run2UltraLegacy_v3/"+year+"/bChargeTagID/"
...
def Run_TTLJ_TTLL(year,ID):
    ...
    filepath_TTLJ=maindir+"TTsemiLepChargeScoreEfficiencyMeasurement_TTLJ_powheg.root"
    filepath_TTLL=maindir+"TTsemiLepChargeScoreEfficiencyMeasurement_TTLL_powheg.root"
    ...
    CompareTwoHists(hEff_TTLJ_bplus.h1_eff,"TTLJ_bplus",hEff_TTLL_bplus.h1_eff,"TTLL_bplus",year+"__"+ID+"__"+"TTLJ__VS__TTLL__both_bplus")
    CompareTwoHists(hEff_TTLJ_bminus.h1_eff,"TTLJ_bminus",hEff_TTLL_bminus.h1_eff,"TTLL_bminus",year+"__"+ID+"__"+"TTLJ__VS__TTLL__both_bminus")
...
def Run_TT_DY(year,ID):
    ...
    filepath_TT=maindir+"hadd_TTLJ_TTLL.root"
    filepath_DY=maindir+"hadd_DY.root"
    ...
    CompareTwoHists(hEff_TT_bplus.h1_eff,"TT_bplus",hEff_DY_bplus.h1_eff,"DY_bplus",year+"__"+ID+"__"+"TT__VS__DY__both_bplus")
    CompareTwoHists(hEff_TT_bminus.h1_eff,"TT_bminus",hEff_DY_bminus.h1_eff,"DY_bminus",year+"__"+ID+"__"+"TT__VS__DY__both_bminus")

def Run_TT_VV(year,ID):
    


    filepath_TT=maindir+"hadd_TTLJ_TTLL.root"
    filepath_VV=maindir+"hadd_VV.root"
    ...
    hEff_VV_bplus=hEff(year,ID,'plus',filepath_VV)
    hEff_VV_bminus=hEff(year,ID,'minus',filepath_VV)
    #class hEff:
    #    def __init__(self,year,ID,bsign):
    
    
    CompareTwoHists(hEff_TT_bplus.h1_eff,"TT_bplus",hEff_VV_bplus.h1_eff,"VV_bplus",year+"__"+ID+"__"+"TT__VS__VV__both_bplus")
    CompareTwoHists(hEff_TT_bminus.h1_eff,"TT_bminus",hEff_VV_bminus.h1_eff,"VV_bminus",year+"__"+ID+"__"+"TT__VS__VV__both_bminus")    
