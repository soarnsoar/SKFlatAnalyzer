...
eval `scramv1 ru -sh`
cd /data6/Users/jhchoi/TMVA/TMVA_TOOL/ws/TTSemiLepJetAssignment_ProduceTrainingTree/WORKDIR_TTSemiLepJetAssignment_ntrial/1.0/TTSemiLepJetAssignment_ProduceTrainingTree/2016preVFP/2016preVFP__5__128__500__0.2/Trf_G/0
(cd /data6/Users/jhchoi/TMVA/TMVA_TOOL/ws/TTSemiLepJetAssignment_ProduceTrainingTree&&cd WORKDIR_TTSemiLepJetAssignment_ntrial/1.0/TTSemiLepJetAssignment_ProduceTrainingTree/2016preVFP/2016preVFP__5__128__500__0.2/Trf_G/0&&python /data6/Users/jhchoi/TMVA/TMVA_TOOL/script/run_TTSemiLepJetAssignment_ProduceTrainingTree.py --name 2016preVFP__5__128__500__0.2 --nlayer 5 --nnode 128 --batchsize 500 --dropout 0.2 --nepoch 300 --version 1.0 --year 2016preVFP --analyzer TTSemiLepJetAssignment_ProduceTrainingTree --transform G --flag reduction_1M__)
myerr=$?
ntry=1
echo "myerr=$myerr"
while [ $myerr -ne 0 ]
...
if [ $myerr -eq 0 ]
then
mv /data6/Users/jhchoi/TMVA/TMVA_TOOL/ws/TTSemiLepJetAssignment_ProduceTrainingTree/WORKDIR_TTSemiLepJetAssignment_ntrial/1.0/TTSemiLepJetAssignment_ProduceTrainingTree/2016preVFP/2016preVFP__5__128__500__0.2/Trf_G/0/run.jid /data6/Users/jhchoi/TMVA/TMVA_TOOL/ws/TTSemiLepJetAssignment_ProduceTrainingTree/WORKDIR_TTSemiLepJetAssignment_ntrial/1.0/TTSemiLepJetAssignment_ProduceTrainingTree/2016preVFP/2016preVFP__5__128__500__0.2/Trf_G/0/run.done
fi
