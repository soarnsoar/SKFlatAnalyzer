...
eval `scramv1 ru -sh`
cd /data6/Users/jhchoi/TMVA/TMVA_TOOL/ws/WORKDIR_ntrial/2409.2/EEMu_MuMuE_Method/2016preVFP/electron/electron2016preVFP__5__256__1000__0.4/Trf_G/61
(cd /data6/Users/jhchoi/TMVA/TMVA_TOOL/ws&&cd WORKDIR_ntrial/2409.2/EEMu_MuMuE_Method/2016preVFP/electron/electron2016preVFP__5__256__1000__0.4/Trf_G/61&&python /data6/Users/jhchoi/TMVA/TMVA_TOOL/script/run_single.py --name electron2016preVFP__5__256__1000__0.4 --nlayer 5 --nnode 256 --batchsize 1000 --dropout 0.4 --nepoch 300 --version 2409.2 --channel electron --year 2016preVFP --analyzer EEMu_MuMuE_Method --transform G)
myerr=$?
ntry=1
echo "myerr=$myerr"
while [ $myerr -ne 0 ]
