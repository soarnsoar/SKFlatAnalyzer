...
eval `scramv1 ru -sh`
cd /d0/scratch/jhchoi/v2409.2/WORKDIR_ntrial/2409.2/EEMu_MuMuE_Method/2016preVFP/jet/jet2016preVFP__5__64__1000__0.2/Trf_N/86
(cd /d0/scratch/jhchoi/v2409.2&&cd WORKDIR_ntrial/2409.2/EEMu_MuMuE_Method/2016preVFP/jet/jet2016preVFP__5__64__1000__0.2/Trf_N/86&&python /u/user/jhchoi/bbbar_asym/dnn/TMVA_TOOL/script/run_single.py --name jet2016preVFP__5__64__1000__0.2 --nlayer 5 --nnode 64 --batchsize 1000 --dropout 0.2 --nepoch 300 --version 2409.2 --channel jet --year 2016preVFP --analyzer EEMu_MuMuE_Method --transform N)
myerr=$?
ntry=1
echo "myerr=$myerr"
while [ $myerr -ne 0 ]
...
if [ $myerr -eq 0 ]
then
mv /d0/scratch/jhchoi/v2409.2/WORKDIR_ntrial/2409.2/EEMu_MuMuE_Method/2016preVFP/jet/jet2016preVFP__5__64__1000__0.2/Trf_N/86/run.jid /d0/scratch/jhchoi/v2409.2/WORKDIR_ntrial/2409.2/EEMu_MuMuE_Method/2016preVFP/jet/jet2016preVFP__5__64__1000__0.2/Trf_N/86/run.done
fi
