...
eval `scramv1 ru -sh`
cd /u/user/jhchoi/bbbar_asym/dnn/TMVA_TOOL/ws_v2512.5/WORKDIR_FIN/2512.5/2016preVFP/muon/I__Grad__Shrinkage__0.005__NTrees__500__MaxDepth__5__MinNodeSize__5__UseBaggedBoost__True__BaggedSampleFraction__0.1__SeparationType__GiniIndex__nCuts__20__IgnoreNegWeightsInTraining__True/idx_0
(python3 /u/user/jhchoi/bbbar_asym/dnn/TMVA_TOOL/script/BDT/run_single_BDT.py  --transform I --BoostType Grad --Shrinkage 0.005 --NTrees 500 --MaxDepth 5 --MinNodeSize 5 --UseBaggedBoost True --BaggedSampleFraction 0.1 --SeparationType GiniIndex --nCuts 20 --IgnoreNegWeightsInTraining True --analyzer EEMu_MuMuE_Method --version 2512.5_2016preVFP --name FIN_BDT_2016preVFP --year 2016preVFP --channel muon&&ls)
myerr=$?
ntry=1
echo "myerr=$myerr"
while [ $myerr -ne 0 ]
do
ntry=`expr $ntry + 1`
(echo ${_CONDOR_SCRATCH_DIR}&&cd $_CONDOR_SCRATCH_DIR&&python3 /u/user/jhchoi/bbbar_asym/dnn/TMVA_TOOL/script/BDT/run_single_BDT.py  --transform I --BoostType Grad --Shrinkage 0.005 --NTrees 500 --MaxDepth 5 --MinNodeSize 5 --UseBaggedBoost True --BaggedSampleFraction 0.1 --SeparationType GiniIndex --nCuts 20 --IgnoreNegWeightsInTraining True --analyzer EEMu_MuMuE_Method --version 2512.5_2016preVFP --name FIN_BDT_2016preVFP --year 2016preVFP --channel muon&&ls)
myerr=$?
echo ntry="$ntry"
echo "myerr=$myerr"
if [ $ntry -gt 1 ]
...
if [ $myerr -eq 0 ]
then
mv /u/user/jhchoi/bbbar_asym/dnn/TMVA_TOOL/ws_v2512.5/WORKDIR_FIN/2512.5/2016preVFP/muon/I__Grad__Shrinkage__0.005__NTrees__500__MaxDepth__5__MinNodeSize__5__UseBaggedBoost__True__BaggedSampleFraction__0.1__SeparationType__GiniIndex__nCuts__20__IgnoreNegWeightsInTraining__True/idx_0/run.jid /u/user/jhchoi/bbbar_asym/dnn/TMVA_TOOL/ws_v2512.5/WORKDIR_FIN/2512.5/2016preVFP/muon/I__Grad__Shrinkage__0.005__NTrees__500__MaxDepth__5__MinNodeSize__5__UseBaggedBoost__True__BaggedSampleFraction__0.1__SeparationType__GiniIndex__nCuts__20__IgnoreNegWeightsInTraining__True/idx_0/run.done
fi
