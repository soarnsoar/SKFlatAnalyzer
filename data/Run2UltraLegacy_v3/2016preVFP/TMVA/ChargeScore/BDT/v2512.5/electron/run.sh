...
eval `scramv1 ru -sh`
cd /u/user/jhchoi/bbbar_asym/dnn/TMVA_TOOL/ws_v2512.5/WORKDIR_FIN/2512.5/2016preVFP/electron/G__Grad__Shrinkage__0.05__NTrees__200__MaxDepth__3__MinNodeSize__1__UseBaggedBoost__True__BaggedSampleFraction__0.3__SeparationType__GiniIndex__nCuts__20__IgnoreNegWeightsInTraining__True/idx_0
(echo ${_CONDOR_SCRATCH_DIR}&&cd $_CONDOR_SCRATCH_DIR&&python3 /u/user/jhchoi/bbbar_asym/dnn/TMVA_TOOL/script/BDT/run_single_BDT.py  --transform G --BoostType Grad --Shrinkage 0.05 --NTrees 200 --MaxDepth 3 --MinNodeSize 1 --UseBaggedBoost True --BaggedSampleFraction 0.3 --SeparationType GiniIndex --nCuts 20 --IgnoreNegWeightsInTraining True --analyzer EEMu_MuMuE_Method --version 2512.5_2016preVFP --name FIN_BDT_2016preVFP --year 2016preVFP --channel electron&&ls)
myerr=$?
ntry=1
echo "myerr=$myerr"
while [ $myerr -ne 0 ]
...
if [ $myerr -eq 0 ]
then
mv /u/user/jhchoi/bbbar_asym/dnn/TMVA_TOOL/ws_v2512.5/WORKDIR_FIN/2512.5/2016preVFP/electron/G__Grad__Shrinkage__0.05__NTrees__200__MaxDepth__3__MinNodeSize__1__UseBaggedBoost__True__BaggedSampleFraction__0.3__SeparationType__GiniIndex__nCuts__20__IgnoreNegWeightsInTraining__True/idx_0/run.jid /u/user/jhchoi/bbbar_asym/dnn/TMVA_TOOL/ws_v2512.5/WORKDIR_FIN/2512.5/2016preVFP/electron/G__Grad__Shrinkage__0.05__NTrees__200__MaxDepth__3__MinNodeSize__1__UseBaggedBoost__True__BaggedSampleFraction__0.3__SeparationType__GiniIndex__nCuts__20__IgnoreNegWeightsInTraining__True/idx_0/run.done
fi
